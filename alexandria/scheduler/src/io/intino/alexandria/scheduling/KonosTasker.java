...
import io.intino.alexandria.scheduling.directory.DirectoryTask;
import org.quartz.JobDetail;
import org.quartz.Scheduler;
import org.quartz.SchedulerException;
import org.quartz.Trigger;
import org.quartz.impl.StdSchedulerFactory;
import io.intino.alexandria.scheduling.directory.KonosDirectorySentinel;
...
public class KonosTasker {
	...
	public void watchDirectory(String name, File directory, DirectoryTask task, KonosDirectorySentinel.Event... events) throws SchedulerException {
		KonosDirectorySentinel sentinel = new KonosDirectorySentinel(directory, task, events);
