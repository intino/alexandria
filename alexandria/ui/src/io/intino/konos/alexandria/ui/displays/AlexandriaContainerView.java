...
public abstract class AlexandriaContainerView<DN extends AlexandriaDisplayNotifier> extends AlexandriaElementView<DN, ElementViewDisplayProvider> {
	private Panel context;
	private Item target;
	private List<Consumer<OpenItemEvent>> openItemListeners = new ArrayList<>();

	public AlexandriaContainerView(Box box) {
		super(box);
	}
