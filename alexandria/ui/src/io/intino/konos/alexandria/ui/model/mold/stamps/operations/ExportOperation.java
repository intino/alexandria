...
public class ExportOperation extends Operation<String> {
	...
	public Resource execute(Item item, Instant from, Instant to, String option, UISession session) {
	...
	public interface Execution {
		Resource export(Object object, Instant from, Instant to, String option, UISession session);
	}
}
