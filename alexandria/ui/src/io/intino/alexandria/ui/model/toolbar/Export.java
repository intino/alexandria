...
public class Export extends Operation {
	...
	public Resource execute(Element element, Instant from, Instant to, String displayId, UISession session) {
	...
	public interface Execution {
		Resource export(Element element, Instant from, Instant to, String displayId, UISession session);
	}
}
