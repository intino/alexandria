...
public class DownloadSelection extends Operation {
	...
	public Resource execute(Element element, String option, List<Item> selection, User user) {
		List<Object> selectionObjects = selection.stream().map(Item::object).collect(toList());
		return this.execution != null ? this.execution.download(element, option, selectionObjects, user) : null;
	}
	...
	public interface Execution {
		Resource download(Element element, String option, List<Object> selection, User user);
	}
}
