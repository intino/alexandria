...
import io.intino.konos.alexandria.activity.box.displays.builders.PlatformInfoBuilder;
...
import io.intino.konos.alexandria.activity.box.model.layout.options.Option;
import io.intino.konos.alexandria.activity.box.model.layout.options.Options;
import io.intino.konos.alexandria.activity.box.model.renders.*;
import io.intino.konos.alexandria.activity.box.schemas.PlatformInfo;
import io.intino.konos.alexandria.activity.box.schemas.Reference;
import io.intino.konos.alexandria.activity.box.schemas.ReferenceProperty;
...
public abstract class AlexandriaLayoutDisplay<DN extends AlexandriaDisplayNotifier> extends AlexandriaElementStoreDisplay<DN> {
    ...
    @Override
    protected io.intino.konos.alexandria.activity.box.model.Item targetWithLabel(String label) {
        Item item = itemWithLabel(label);
        return item != null ? item.target() : null;
    }

    @Override
    protected AlexandriaElementDisplay newDisplay(Element element, io.intino.konos.alexandria.activity.box.model.Item item) {
    ...
    private String labelOf(ElementRender render, Element element, io.intino.konos.alexandria.activity.box.model.Item item) {
    ...
    private Item itemOf(ElementRender render, Element element, io.intino.konos.alexandria.activity.box.model.Item target) {
        return new Item() {
            @Override
            public String name() {
            ...
            @Override
            public io.intino.konos.alexandria.activity.box.model.Item target() {
                return target;
            }
        };
    }
    ...
    protected interface Item {
        ...
        Group group();
        Element element();
        io.intino.konos.alexandria.activity.box.model.Item target();
    }
