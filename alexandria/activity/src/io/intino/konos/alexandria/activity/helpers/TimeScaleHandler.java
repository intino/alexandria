...
public class TimeScaleHandler {
	...
	public ZoomRange zoomRange() {
		Map<TimeScale, io.intino.konos.alexandria.activity.helpers.Bounds.Zoom> zooms = bounds.zooms();
	...
	private TimeRange initialTimeRange(TimeScale scale) {
		...
		if (bounds.zooms().size() > 0) {
			...
			if (bounds.mode() == io.intino.konos.alexandria.activity.helpers.Bounds.Mode.ToTheLast) {
	...
	public static class Bounds {
		...
		public io.intino.konos.alexandria.activity.helpers.Bounds.Mode mode() {
			return mode;
		}

		public Bounds mode(io.intino.konos.alexandria.activity.helpers.Bounds.Mode mode) {
			this.mode = mode;
			return this;
		}

		public Map<TimeScale, io.intino.konos.alexandria.activity.helpers.Bounds.Zoom> zooms() {
			return zooms;
		}
