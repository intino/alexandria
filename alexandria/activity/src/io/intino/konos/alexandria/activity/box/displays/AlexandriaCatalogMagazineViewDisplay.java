...
import io.intino.konos.alexandria.activity.box.displays.notifiers.AlexandriaCatalogMagazineViewDisplayNotifier;
...
public class AlexandriaCatalogMagazineViewDisplay extends ActivityDisplay<AlexandriaCatalogMagazineViewDisplayNotifier> implements AlexandriaCatalogViewDisplay {
	...
	private io.intino.konos.alexandria.activity.box.model.Item item = null;
	...
	private void loadRecord() {
		...
		List<io.intino.konos.alexandria.activity.box.model.Item> items = provider.items(0, count, condition);
