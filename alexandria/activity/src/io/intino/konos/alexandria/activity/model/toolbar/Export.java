...
public class Export extends Operation {
	...
	public Resource execute(Element element, Instant from, Instant to, User user) {
		return execution != null ? execution.export(element, from, to, user) : null;
	}
	...
	public interface Execution {
		Resource export(Element element, Instant from, Instant to, User user);
	}
}
