...
import io.intino.konos.alexandria.activity.box.model.Layout;

import java.util.HashMap;
import java.util.Map;

public abstract class AlexandriaElementStoreDisplay<DN extends AlexandriaDisplayNotifier> extends AlexandriaElementDisplay<Layout, DN> implements ElementDisplayManager {
