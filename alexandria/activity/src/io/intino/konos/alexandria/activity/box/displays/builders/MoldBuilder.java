...
import io.intino.konos.alexandria.activity.box.model.mold.stamps.icons.SumusIcon;
...
import io.intino.konos.alexandria.activity.box.model.mold.stamps.operations.OpenDialogOperation;
import io.intino.konos.alexandria.activity.box.model.mold.stamps.operations.TaskOperation;
import io.intino.konos.alexandria.activity.box.schemas.Mold;
import io.intino.konos.alexandria.activity.box.schemas.MoldBlock;
import io.intino.konos.alexandria.activity.box.schemas.Property;
import io.intino.konos.alexandria.activity.box.schemas.Stamp;
...
public class MoldBuilder {
    ...
    public static Mold build(io.intino.konos.alexandria.activity.box.model.Mold mold) {
    ...
    private static Stamp buildStamp(io.intino.konos.alexandria.activity.box.model.mold.Stamp stamp) {
    ...
    private static String shapeOf(io.intino.konos.alexandria.activity.box.model.mold.Stamp stamp) {
    ...
    private static void addCommonProperties(List<Property> propertyList, io.intino.konos.alexandria.activity.box.model.mold.Stamp stamp) {
    ...
    private static void addRatingProperties(List<Property> propertyList, io.intino.konos.alexandria.activity.box.model.mold.Stamp stamp) {
        if (! (stamp instanceof Rating)) return;
        propertyList.add(shapeProperty("icon", ((Rating)stamp).ratingIcon()));
    }

    private static void addEmbeddedCatalogProperties(List<Property> propertyList, io.intino.konos.alexandria.activity.box.model.mold.Stamp stamp) {
        if (! (stamp instanceof EmbeddedCatalog)) return;
        propertyList.add(shapeProperty("catalog", ((EmbeddedCatalog)stamp).catalog().name()));
    }

    private static void addIconProperties(List<Property> propertyList, io.intino.konos.alexandria.activity.box.model.mold.Stamp stamp) {
        if (! (stamp instanceof Icon)) return;
        propertyList.add(shapeProperty("icon-type", stamp instanceof SumusIcon ? "sumus" : ""));
    }

    private static void addDownloadOperationProperties(List<Property> propertyList, io.intino.konos.alexandria.activity.box.model.mold.Stamp stamp) {
    ...
    private static void addExportOperationProperties(List<Property> propertyList, io.intino.konos.alexandria.activity.box.model.mold.Stamp stamp) {
