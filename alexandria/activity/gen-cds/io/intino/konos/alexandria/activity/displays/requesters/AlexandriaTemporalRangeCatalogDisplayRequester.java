...
public class AlexandriaTemporalRangeCatalogDisplayRequester extends DisplayRequester {

	public AlexandriaTemporalRangeCatalogDisplayRequester(ActivitySparkManager manager, AlexandriaDisplayNotifierProvider notifierProvider) {
		super(manager, notifierProvider);
	}

	@Override
	public void execute() throws AlexandriaException {
		AlexandriaTemporalRangeCatalogDisplay display = display();
