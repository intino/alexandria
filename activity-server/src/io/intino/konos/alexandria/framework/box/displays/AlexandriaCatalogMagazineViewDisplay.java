...
import io.intino.konos.alexandria.framework.box.displays.notifiers.AlexandriaCatalogMagazineViewDisplayNotifier;
...
import static io.intino.konos.alexandria.framework.box.helpers.ElementHelper.itemDisplayProvider;
...
public class AlexandriaCatalogMagazineViewDisplay extends ActivityDisplay<AlexandriaCatalogMagazineViewDisplayNotifier> implements AlexandriaCatalogViewDisplay {
	...
	private io.intino.konos.alexandria.framework.box.model.Item item = null;
	...
	private void loadRecord() {
		...
		List<io.intino.konos.alexandria.framework.box.model.Item> items = provider.items(0, count, condition);
