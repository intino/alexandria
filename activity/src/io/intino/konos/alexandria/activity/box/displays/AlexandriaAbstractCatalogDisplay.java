...
import io.intino.konos.alexandria.activity.box.displays.ElementViewDisplay.OpenItemEvent;
...
import io.intino.konos.alexandria.activity.box.model.catalog.Events;
import io.intino.konos.alexandria.activity.box.model.catalog.Scope;
import io.intino.konos.alexandria.activity.box.model.catalog.arrangement.Group;
import io.intino.konos.alexandria.activity.box.model.catalog.arrangement.GroupMap;
import io.intino.konos.alexandria.activity.box.model.catalog.arrangement.Grouping;
...
import io.intino.konos.alexandria.activity.box.model.catalog.views.GridView;
import io.intino.konos.alexandria.activity.box.model.catalog.views.ListView;
import io.intino.konos.alexandria.activity.box.model.catalog.views.MagazineView;
...
import io.intino.konos.alexandria.activity.box.schemas.GroupingGroup;
...
public abstract class AlexandriaAbstractCatalogDisplay<E extends Catalog, DN extends AlexandriaDisplayNotifier> extends AlexandriaElementDisplay<E, DN> implements CatalogViewDisplayProvider {
	...
	@Override
	public List<io.intino.konos.alexandria.activity.box.model.catalog.arrangement.Sorting> sortings() {
		return element().sortings();
	}

	@Override
	public io.intino.konos.alexandria.activity.box.model.catalog.arrangement.Sorting sorting(String key) {
