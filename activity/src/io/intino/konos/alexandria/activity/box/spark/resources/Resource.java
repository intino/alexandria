...
import io.intino.konos.alexandria.activity.box.displays.MessageCarrier;
import io.intino.konos.alexandria.activity.box.services.AuthService;
import io.intino.konos.alexandria.activity.box.services.AuthService.Authentication;
import io.intino.konos.alexandria.activity.box.services.auth.Space;
import io.intino.konos.alexandria.activity.box.services.auth.exceptions.CouldNotInvalidateAccessToken;
import io.intino.konos.alexandria.activity.box.services.auth.exceptions.CouldNotObtainAuthorizationUrl;
import io.intino.konos.alexandria.activity.box.services.auth.exceptions.CouldNotObtainRequestToken;
import io.intino.konos.alexandria.activity.box.services.auth.exceptions.SpaceAuthCallbackUrlIsNull;
import io.intino.konos.alexandria.activity.box.services.push.ActivityClient;
import io.intino.konos.alexandria.activity.box.services.push.ActivitySession;
import io.intino.konos.alexandria.activity.box.services.push.Browser;
...
public abstract class Resource implements io.intino.konos.alexandria.rest.Resource {
	...
	private String authenticate(Authentication authentication) {
		try {
			return io.intino.konos.alexandria.activity.box.utils.RequestHelper.post(authentication.authenticationUrl(authentication.requestToken())).toString();
