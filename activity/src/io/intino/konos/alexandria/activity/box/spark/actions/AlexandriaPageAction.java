package io.intino.konos.alexandria.activity.box.spark.actions;

import cottons.utils.StreamHelper;
import io.intino.konos.alexandria.activity.box.Asset;
...
public abstract class AlexandriaPageAction {
	...
	public io.intino.konos.alexandria.activity.box.services.push.ActivitySession session;
