...
public class TimeScaleHandler {
	...
	public ZoomRange zoomRange() {
		Map<TimeScale, io.intino.alexandria.framework.box.helpers.Bounds.Zoom> zooms = bounds.zooms();
	...
	private TimeRange initialTimeRange(TimeScale scale) {
		...
		if (bounds.mode() == io.intino.alexandria.framework.box.helpers.Bounds.Mode.ToTheLast) {
	...
	public static class Bounds {
		...
		private io.intino.alexandria.framework.box.helpers.Bounds.Mode mode;
		private Map<TimeScale, io.intino.alexandria.framework.box.helpers.Bounds.Zoom> zooms;
		...
		public io.intino.alexandria.framework.box.helpers.Bounds.Mode mode() {
			return mode;
		}

		public Bounds mode(io.intino.alexandria.framework.box.helpers.Bounds.Mode mode) {
			this.mode = mode;
			return this;
		}

		public Map<TimeScale, io.intino.alexandria.framework.box.helpers.Bounds.Zoom> zooms() {
			return zooms;
		}

		public Bounds zooms(Map<TimeScale, io.intino.alexandria.framework.box.helpers.Bounds.Zoom> zooms) {
			this.zooms = zooms;
			return this;
		}
