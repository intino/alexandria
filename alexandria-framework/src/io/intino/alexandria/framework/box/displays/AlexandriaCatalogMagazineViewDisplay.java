...
import io.intino.alexandria.framework.box.displays.notifiers.AlexandriaCatalogMagazineViewDisplayNotifier;
...
public class AlexandriaCatalogMagazineViewDisplay extends ActivityDisplay<AlexandriaCatalogMagazineViewDisplayNotifier> implements AlexandriaCatalogViewDisplay {
	...
	private io.intino.alexandria.framework.box.model.Item item = null;
	...
	private void loadRecord() {
		...
		List<io.intino.alexandria.framework.box.model.Item> items = provider.items(0, count, condition);
