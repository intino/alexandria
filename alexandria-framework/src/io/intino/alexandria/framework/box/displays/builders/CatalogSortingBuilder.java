...
public class CatalogSortingBuilder {
    ...
    public static Sorting build(io.intino.alexandria.framework.box.model.catalog.arrangement.Sorting sorting) {
    ...
    public static List<Sorting> buildList(List<io.intino.alexandria.framework.box.model.catalog.arrangement.Sorting> sortingList) {
