...
import io.intino.alexandria.framework.box.displays.notifiers.AlexandriaMenuLayoutDisplayNotifier;
...
public class AlexandriaMenuLayoutDisplay<DN extends AlexandriaMenuLayoutDisplayNotifier> extends AlexandriaLayoutDisplay<DN> {
	...
	@Override
	protected io.intino.alexandria.framework.box.model.Item currentItem() {
		return null;
	}
