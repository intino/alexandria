...
import io.intino.alexandria.framework.box.displays.builders.PlatformInfoBuilder;
import io.intino.alexandria.framework.box.displays.builders.ReferenceBuilder;
...
import io.intino.alexandria.framework.box.model.layout.options.Group;
import io.intino.alexandria.framework.box.model.layout.options.Option;
import io.intino.alexandria.framework.box.model.layout.options.Options;
import io.intino.alexandria.framework.box.model.Panel;
import io.intino.alexandria.framework.box.model.renders.*;
...
import io.intino.alexandria.framework.box.schemas.UserInfo;
...
public abstract class AlexandriaLayoutDisplay<DN extends DisplayNotifier> extends AlexandriaElementStoreDisplay<DN> {
    ...
    @Override
    protected io.intino.alexandria.framework.box.model.Item targetWithLabel(String label) {
        Item item = itemWithLabel(label);
    ...
    private String labelOf(ElementRender render, Element element, io.intino.alexandria.framework.box.model.Item item) {
    ...
    private Item itemOf(ElementRender render, Element element, io.intino.alexandria.framework.box.model.Item target) {
        return new Item() {
            @Override
            public String name() {
            ...
            @Override
            public io.intino.alexandria.framework.box.model.Item target() {
                return target;
            }
        };
    }
    ...
    protected interface Item {
        ...
        Group group();
        Element element();
        io.intino.alexandria.framework.box.model.Item target();
    }
