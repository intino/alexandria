...
import io.intino.alexandria.framework.box.model.catalog.views.MapView;
import io.intino.alexandria.framework.box.model.toolbar.*;
import io.intino.alexandria.framework.box.model.toolbar.GroupingSelection;
import io.intino.alexandria.framework.box.schemas.*;
import io.intino.alexandria.framework.box.schemas.Operation;
...
public class ElementViewBuilder {
    ...
    public static ElementView build(io.intino.alexandria.framework.box.displays.ElementView view) {
    ...
    private static Toolbar buildToolbar(io.intino.alexandria.framework.box.model.Toolbar toolbar) {
        Toolbar result = new Toolbar();
        toolbar.operations().forEach(op -> result.operationList().add(buildOperation(op)));
        return result;
    }

    private static Operation buildOperation(io.intino.alexandria.framework.box.model.toolbar.Operation operation) {
    ...
    private static String when(io.intino.alexandria.framework.box.model.toolbar.Operation operation) {
    ...
    private static List<Property> propertiesOf(io.intino.alexandria.framework.box.model.toolbar.Operation operation) {
    ...
    private static String type(io.intino.alexandria.framework.box.model.toolbar.Operation operation) {
    ...
    public static List<ElementView> buildList(List<io.intino.alexandria.framework.box.displays.ElementView> viewList) {
        return viewList.stream().map(ElementViewBuilder::build).collect(toList());
    }

    private static void addMapViewProperties(ElementView result, io.intino.alexandria.framework.box.displays.ElementView view) {
