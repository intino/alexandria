...
import io.intino.alexandria.framework.box.displays.ElementViewDisplay.OpenItemEvent;
...
import io.intino.alexandria.framework.box.model.Toolbar;
import io.intino.alexandria.framework.box.model.Catalog;
import io.intino.alexandria.framework.box.model.catalog.Events;
import io.intino.alexandria.framework.box.model.catalog.Scope;
import io.intino.alexandria.framework.box.model.catalog.arrangement.Group;
import io.intino.alexandria.framework.box.model.catalog.arrangement.GroupMap;
import io.intino.alexandria.framework.box.model.catalog.arrangement.Grouping;
...
import io.intino.alexandria.framework.box.model.catalog.views.GridView;
import io.intino.alexandria.framework.box.model.catalog.views.ListView;
import io.intino.alexandria.framework.box.model.catalog.views.MagazineView;
import io.intino.alexandria.framework.box.model.catalog.views.MoldView;
import io.intino.alexandria.framework.box.model.Mold;
import io.intino.alexandria.framework.box.schemas.ClusterGroup;
import io.intino.alexandria.framework.box.schemas.GroupingGroup;
...
public abstract class AlexandriaAbstractCatalogDisplay<E extends Catalog, DN extends DisplayNotifier> extends AlexandriaElementDisplay<E, DN> implements CatalogViewDisplayProvider {
	...
	@Override
	public List<io.intino.alexandria.framework.box.model.catalog.arrangement.Sorting> sortings() {
		return element().sortings();
	}

	@Override
	public io.intino.alexandria.framework.box.model.catalog.arrangement.Sorting sorting(String key) {
