...
public interface CatalogViewDisplayProvider extends ElementViewDisplayProvider {
    ...
    List<io.intino.konos.alexandria.framework.box.model.catalog.arrangement.Sorting> sortings();

    io.intino.konos.alexandria.framework.box.model.catalog.arrangement.Sorting sorting(String name);
