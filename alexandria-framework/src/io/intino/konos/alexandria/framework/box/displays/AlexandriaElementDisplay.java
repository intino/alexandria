...
import io.intino.konos.alexandria.framework.box.model.catalog.View;
...
import io.intino.konos.alexandria.framework.box.model.mold.stamps.Display;
...
public abstract class AlexandriaElementDisplay<E extends Element, DN extends DisplayNotifier> extends ActivityDisplay<DN> implements ItemBuilder.ItemBuilderProvider {
	...
	private io.intino.konos.alexandria.framework.box.schemas.Item currentItem_() {
