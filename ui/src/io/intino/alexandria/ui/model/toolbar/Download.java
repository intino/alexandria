...
public class Download extends Operation {
	...
	public Resource execute(Element element, String option, String displayId, UISession session) {
	...
	public interface Execution {
		Resource download(Element element, String option, String displayId, UISession session);
	}
}
