...
public class JavaAccessorTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "parameter & query & required")), (condition("type", "dateTimeData | dateData")), (condition("trigger", "toMap"))).add(literal("put(\"")).add(mark("name")).add(literal("\", String.valueOf(")).add(mark("name", "SnakeCaseToCamelCase", "firstLowerCase")).add(literal(".toInstant(java.time.ZoneOffset.UTC).getEpochSecond()));")),
