import io.intino.alexandria.nessaccesoroctavio.EventStore;
import io.intino.alexandria.nessaccesoroctavio.NessAccessor;
...
public class NessWrapper {
	...
	public void shouldStartNess() throws Exception {
		...
		final EventStore.Tank tank = nessAccessor.eventStore().add("adquiver.advertiser");
	...
	public void sendAttachment() {
		...
		final EventStore.Tank tank = nessAccessor.eventStore().add("happysense.dialog");
