...
import io.intino.alexandria.ness.eventstore.MessageInputStreamBuilder;
import io.intino.alexandria.ness.eventstore.Sorter;
...
import static io.intino.alexandria.ness.eventstore.AttachmentLoader.loadAttachments;
...
public class Tank extends AbstractTank {
	...
	public static String dayOf(String instant) {
		return instant.replace("-", "").substring(0, 8);
	}

	public static String hourOf(String instant) {
		return dayOf(instant) + instant.substring(instant.indexOf("T") + 1, instant.indexOf(":"));
	}

	public static String monthOf(String instant) {
