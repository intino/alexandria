...
import io.intino.alexandria.nessaccessor.NessAccessor.SetStore.Set;
import io.intino.alexandria.nessaccessor.NessAccessor.SetStore.Tank;
import io.intino.alexandria.nessaccessor.NessAccessor.SetStore.Timetag;
import io.intino.alexandria.nessaccessor.NessAccessor.SetStore.Tub;
import io.intino.alexandria.nessaccessor.SetStoreAnalytics.TankHistogram.Axis;
...
public class SetStoreAnalytics {
    ...
    public static class TankEvolution {
        ...
        public Stream<Point> points(Function<Set, Boolean> filter) {
            return tubs.map(t->point(t, filter));
        }

        private Point<Timetag> point(Tub tub, Function<Set, Boolean> filter) {
