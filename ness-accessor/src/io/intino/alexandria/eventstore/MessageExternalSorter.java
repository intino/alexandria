...
import io.intino.alexandria.eventstore.AttachmentLoader;
...
import static io.intino.alexandria.eventstore.Sorter.SEPARATOR;
import static java.time.Instant.parse;

public class MessageExternalSorter {
	private static final String INL = ".inl";
	private static Logger logger = LoggerFactory.getLogger(io.intino.alexandria.eventstore.MessageExternalSorter.class);
	...
	private File processBatch(List<Message> messages, int batch) {
		...
		try {
			io.intino.alexandria.eventstore.TimSort<Message> sorter = new io.intino.alexandria.eventstore.TimSort<>();
