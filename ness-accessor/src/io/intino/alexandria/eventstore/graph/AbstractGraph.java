...
public class AbstractGraph extends io.intino.tara.magritte.GraphWrapper {
	...
	private java.util.List<io.intino.alexandria.eventstore.graph.Tank> tankList = new java.util.ArrayList<>();
	...
	public java.util.List<io.intino.alexandria.eventstore.graph.Tank> tankList() {
		return tankList;
	}

	public java.util.stream.Stream<io.intino.alexandria.eventstore.graph.Tank> tankList(java.util.function.Predicate<io.intino.alexandria.eventstore.graph.Tank> filter) {
		return tankList.stream().filter(filter);
	}

	public io.intino.alexandria.eventstore.graph.Tank tank(int index) {
	...
	public class Create {
		...
		public io.intino.alexandria.eventstore.graph.Tank tank(String qualifiedName) {
			io.intino.alexandria.eventstore.graph.Tank newElement = AbstractGraph.this.graph.createRoot(io.intino.alexandria.eventstore.graph.Tank.class, stash, this.name).a$(io.intino.alexandria.eventstore.graph.Tank.class);
	...
	public class Clear {
	    public void tank(java.util.function.Predicate<io.intino.alexandria.eventstore.graph.Tank> filter) {
	...
	private java.util.HashMap<String, Indexer> _fillIndex() {
		return new java.util.HashMap<String, Indexer>() {{
			put("Tank", new Indexer(node -> tankList.add(node.as(io.intino.alexandria.eventstore.graph.Tank.class)), node -> tankList.remove(node.as(io.intino.alexandria.eventstore.graph.Tank.class)), () -> tankList.clear()));
		}};
	}
