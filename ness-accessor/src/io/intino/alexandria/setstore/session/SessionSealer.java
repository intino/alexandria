package io.intino.alexandria.setstore.session;
...
public class SessionSealer {
	...
	public static void seal(File stageFolder) {
		...
		sessionsMap.values().forEach(v -> new io.intino.ness.setstore.session.SessionSealer(v, stageFolder.getParentFile()).seal());
