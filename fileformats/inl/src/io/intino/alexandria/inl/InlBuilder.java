...
public class InlBuilder {
	private final Object object;
	private final String path;
	private final Mapping mapping;
	private ResourceStore resourceStore;

	public static InlBuilder build(Object object) {
		return build(object, new ResourceStore.Memory());
	}

	public static InlBuilder build(Object object, ResourceStore resourceStore) {
		return new InlBuilder(object, "", new Mapping(), resourceStore);
	}

	private InlBuilder(Object object, String path, Mapping mapping, ResourceStore resourceStore) {
		this.object = object;
		this.path = path;
	...
	private Formatter formatterOf(Object value) {
		return FormatterFactory.get(value.getClass());
	}
	...
	private String serializeItem(Object value) {
		...
		return "\n" + (isPrimitive(aClass) || isArrayOfPrimitives(aClass) ? value.toString() : new InlBuilder(value, type(), mapping, resourceStore).toInl());
	}
	...
	public InlBuilder map(String from, String to) {
		mapping.put(from, to);
		return this;
	}
}
