...
public class MappColumnStreamerOld implements ColumnStreamer {
	private final MappReader reader;
	private final Type type;
	private final String name;

	public MappColumnStreamerOld(MappReader reader) {
		this(reader, Type.Nominal);
	}

	public MappColumnStreamerOld(MappReader reader, String name) {
		this(reader, name, Type.Nominal);
	}

	public MappColumnStreamerOld(MappReader reader, Type type) {
		this(reader, reader.name(), type);
	}

	public MappColumnStreamerOld(MappReader reader, String name, Type type) {
		this.reader = reader;
		this.type = type;
		this.name = name;
	}
	...
	private class MappColumnStream implements ColumnStream {
