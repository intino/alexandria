...
public class Zif_ {
	...
	public void setup() throws IOException {
		String[][] data = new String[][] {
				...
				new String[] {"884d6028-64fd-40f4-9e71-d6d43a4ae18e", "identifier/should_query_identity", "Barack Obama"},
	...
	public void should_search_by_property() throws IOException {
		...
		assertThat(zif.search("feature/status", "enabled").contains("884d6028-64fd-40f4-9e71-d6d43a4ae18e")).isTrue();
		assertThat(zif.search("feature/status", "enabled").size()).isEqualTo(2);
	}
