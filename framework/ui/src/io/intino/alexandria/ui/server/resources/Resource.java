...
public abstract class Resource implements io.intino.alexandria.http.Resource {
	...
	protected final AlexandriaUiManager manager;
	private final DisplayNotifierProvider notifierProvider;

	public Resource(AlexandriaUiManager manager, DisplayNotifierProvider notifierProvider) {
	...
	protected void fillBrowser(AlexandriaUiManager manager, UISession session) {
	...
	private void fillBrowser(AlexandriaUiManager manager) {
