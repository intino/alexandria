...
public class DocsTemplate extends AbstractDocsTemplate<AlexandriaUiBox> {
    ...
    private void addDataWidgets() {
        ...
        body.dataBlock.dataWidgets.add(Model.widget(Model.WidgetType.Form));
    ...
    private void addCatalogWidgets() {
        ...
        body.catalogBlock.catalogWidgets.add(Model.widget(Model.WidgetType.Grid));
        ...
        body.catalogBlock.catalogWidgets.add(Model.widget(Model.WidgetType.GroupingToolbar));
    ...
    private void addOtherWidgets() {
        ...
        body.otherBlock.otherWidgets.add(Model.widget(Model.WidgetType.AppDirectory));
