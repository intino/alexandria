...
public class DownloadSelectionExamplesMold extends AbstractDownloadSelectionExamplesMold<UiFrameworkBox> {

    public DownloadSelectionExamplesMold(UiFrameworkBox box) {
        super(box);
    }
