...
public class MobileDocsTemplate extends AbstractMobileDocsTemplate<AlexandriaUiBox> {
	...
	private static class WidgetGroupDatasource extends PageDatasource<Widget> {
		...
		private static final Map<String, List<Model.WidgetType>> Widgets = new HashMap<>() {{
			...
			put("otherOption", List.of(Model.WidgetType.Block, Model.WidgetType.Chart, Model.WidgetType.Dashboard, Model.WidgetType.AppDirectory, Model.WidgetType.Slider, Model.WidgetType.Dialog, Model.WidgetType.Layer, Model.WidgetType.Divider, Model.WidgetType.User, Model.WidgetType.Selector, Model.WidgetType.Stepper, Model.WidgetType.Frame, Model.WidgetType.MicroSite, Model.WidgetType.HtmlViewer, Model.WidgetType.DateNavigator, Model.WidgetType.Timeline, Model.WidgetType.Eventline, Model.WidgetType.Reel, Model.WidgetType.DocumentEditor, Model.WidgetType.Kpi, Model.WidgetType.Chat));
		}};
