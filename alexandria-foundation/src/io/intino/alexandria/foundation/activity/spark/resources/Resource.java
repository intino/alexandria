...
import io.intino.alexandria.foundation.activity.displays.MessageCarrier;
import io.intino.alexandria.foundation.activity.services.AuthService;
import io.intino.alexandria.foundation.activity.services.AuthService.Authentication;
import io.intino.alexandria.foundation.activity.services.auth.Space;
import io.intino.alexandria.foundation.activity.services.auth.exceptions.CouldNotInvalidateAccessToken;
import io.intino.alexandria.foundation.activity.services.auth.exceptions.CouldNotObtainAuthorizationUrl;
import io.intino.alexandria.foundation.activity.services.auth.exceptions.CouldNotObtainRequestToken;
import io.intino.alexandria.foundation.activity.services.auth.exceptions.SpaceAuthCallbackUrlIsNull;
...
import io.intino.alexandria.foundation.activity.services.push.Browser;
import io.intino.alexandria.foundation.activity.spark.ActivitySparkManager;
import io.intino.alexandria.foundation.activity.utils.RequestHelper;
...
public abstract class Resource implements io.intino.alexandria.foundation.Resource {
