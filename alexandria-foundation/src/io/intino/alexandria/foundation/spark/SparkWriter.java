...
import static io.intino.alexandria.foundation.spark.ResponseAdapter.adapt;
...
class SparkWriter {
	...
	void write(Object object, String name) {
		if (object instanceof Error) writeError((io.intino.alexandria.Error) object, adapt(object));
	...
	private void writeError(io.intino.alexandria.Error response, String message) {
		try {
