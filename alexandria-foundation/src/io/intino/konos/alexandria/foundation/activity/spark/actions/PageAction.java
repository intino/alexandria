package io.intino.konos.alexandria.foundation.activity.spark.actions;
...
public abstract class PageAction {
	...
	public io.intino.konos.alexandria.foundation.activity.services.push.ActivitySession session;
