...
public class ResponseAdapter {
	...
	public static String adapt(Object object) {
		if (object instanceof Error) return adaptError((io.intino.konos.alexandria.Error) object);
	...
	private static String adaptError(io.intino.konos.alexandria.Error error) {
