...
import io.intino.konos.alexandria.foundation.pushservice.Message;
import io.intino.konos.alexandria.foundation.pushservice.Session;
import io.intino.konos.alexandria.foundation.pushservice.SessionManager;
...
public abstract class PushService<S extends Session<C>, C extends Client> implements io.intino.konos.alexandria.foundation.pushservice.PushService<S, C> {
