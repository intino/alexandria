...
import static io.intino.konos.alexandria.foundation.spark.ResponseAdapter.adapt;
...
class SparkWriter {
	...
	private void writeError(io.intino.konos.alexandria.Error response, String message) {
		try {
