...
public class WebPackTemplate extends Template {
	...
	public List<Rule> ruleSet() {
		...
		rules.add(rule().condition(all(allTypes("exposedDisplay"), trigger("gen"))).output(literal("'")).output(placeholder("name")).output(literal("' : './gen/apps/")).output(placeholder("name", "firstUppercase")).output(literal(".js'")));
		...
		rules.add(rule().condition(all(allTypes("exposedDisplay"), trigger("plugin"))).output(literal("new HtmlWebPackPlugin({\n\thash: true,\n\ttitle: \"Test UI\",\n\tchunks: ['")).output(placeholder("name")).output(literal("'],\n\ttemplate: \"./src/")).output(placeholder("name")).output(literal(".html\",\n\tfilename: \"./")).output(placeholder("name")).output(literal(".html\"\n})")));
		return rules;
	}
