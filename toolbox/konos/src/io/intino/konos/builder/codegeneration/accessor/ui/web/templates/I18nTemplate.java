...
public class I18nTemplate extends Template {
	...
	public List<Rule> ruleSet() {
		...
		rules.add(rule().condition(all(allTypes("use"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUpperCase")).output(literal("I18n from \"")).output(placeholder("service", "camelCaseToSnakeCase")).output(literal("/gen/I18n\";")));
