...
public class PassiveViewRequesterTemplate extends Template {
	...
	public List<Rule> ruleSet() {
		...
		rules.add(rule().condition(all(allTypes("parameter"), trigger("request"))).output(literal("fun ")).output(placeholder("name")).output(literal("(value: String)")).output(expression().output(literal(" : ")).output(placeholder("returnType"))).output(literal(" {\n    ")).output(placeholder("method")).output(literal("(UiMessage(\"")).output(placeholder("name")).output(literal("\", \"")).output(placeholder("display", "lowercase")).output(literal("\", element.shortId(), ")).output(placeholder("parameter")).output(placeholder("nullParameter")).output(literal(", element.owner(), element.context()), element.ownerUnit());\n}")));
		rules.add(rule().condition(trigger("request")).output(literal("fun ")).output(placeholder("name")).output(literal("(")).output(expression().output(placeholder("parameterSignature")).output(literal(": ")).output(placeholder("customParameterType"))).output(literal(")")).output(expression().output(literal(" : ")).output(placeholder("returnType"))).output(literal(" {\n    ")).output(placeholder("method")).output(literal("(UiMessage(\"")).output(placeholder("name")).output(literal("\", \"")).output(placeholder("display", "lowercase")).output(literal("\", element.shortId(), ")).output(placeholder("parameter")).output(placeholder("nullParameter")).output(literal(", element.owner(), element.context()), element.ownerUnit());\n}")));
