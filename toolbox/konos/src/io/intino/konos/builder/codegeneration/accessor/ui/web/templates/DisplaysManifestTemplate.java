...
public class DisplaysManifestTemplate extends Template {
	...
	public List<Rule> ruleSet() {
		...
		rules.add(rule().condition(all(allTypes("item", "accessible"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUppercase")).output(literal("Proxy from \"./displays/items/")).output(placeholder("name", "firstUppercase")).output(literal("Proxy\"")));
		...
		rules.add(rule().condition(all(allTypes("row", "accessible"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUppercase")).output(literal("Proxy from \"./displays/rows/")).output(placeholder("name", "firstUppercase")).output(literal("Proxy\"")));
		...
		rules.add(rule().condition(all(allTypes("table", "accessible"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUppercase")).output(literal("Proxy from \"./displays/tables/")).output(placeholder("name", "firstUppercase")).output(literal("Proxy\"")));
		...
		rules.add(rule().condition(all(allTypes("list", "accessible"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUppercase")).output(literal("Proxy from \"./displays/lists/")).output(placeholder("name", "firstUppercase")).output(literal("Proxy\"")));
		...
		rules.add(rule().condition(all(allTypes("magazine", "accessible"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUppercase")).output(literal("Proxy from \"./displays/magazines/")).output(placeholder("name", "firstUppercase")).output(literal("Proxy\"")));
		...
		rules.add(rule().condition(all(allTypes("template", "accessible"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUppercase")).output(literal("Proxy from \"./displays/templates/")).output(placeholder("name", "firstUppercase")).output(literal("Proxy\"")));
		rules.add(rule().condition(all(allTypes("map", "accessible"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUppercase")).output(literal("Proxy from \"./displays/maps/")).output(placeholder("name", "firstUppercase")).output(literal("Proxy\"")));
		...
		rules.add(rule().condition(all(allTypes("block", "accessible"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUppercase")).output(literal("Proxy from \"./displays/blocks/")).output(placeholder("name", "firstUppercase")).output(literal("Proxy\"")));
		...
		rules.add(rule().condition(all(allTypes("component", "accessible"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUppercase")).output(literal("Proxy from \"./displays/components/")).output(placeholder("name", "firstUppercase")).output(literal("Proxy\"")));
		...
		rules.add(rule().condition(all(allTypes("display", "accessible"), trigger("import"))).output(literal("import ")).output(placeholder("name", "firstUppercase")).output(literal("Proxy from \"./displays/")).output(placeholder("name", "firstUppercase")).output(literal("Proxy\"")));
		...
		rules.add(rule().condition(all(allTypes("display"), trigger("export"))).output(placeholder("name", "firstUppercase")).output(placeholder("accessible")));
		rules.add(rule().condition(allTypes("accessible")).output(literal("Proxy")));
		return rules;
	}
