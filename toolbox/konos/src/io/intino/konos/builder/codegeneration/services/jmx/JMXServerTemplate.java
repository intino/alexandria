...
public class JMXServerTemplate extends Template {
	...
	public List<Rule> ruleSet() {
		...
		rules.add(rule().condition(all(allTypes("parameter"), trigger("info"))).output(literal("new MBeanParameterInfo(\"")).output(placeholder("name")).output(literal("\", \"")).output(placeholder("type", "fulltype")).output(literal("\", \"")).output(placeholder("description")).output(literal("\")")));
