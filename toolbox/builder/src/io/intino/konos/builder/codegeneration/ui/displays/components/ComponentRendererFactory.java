...
public class ComponentRendererFactory {
	...
	public <T extends UIRenderer> T renderer(CompilationContext context, Component component, TemplateProvider provider, Target target) {
		...
		if (component.i$(VisualizationComponents.AppDirectory.class)) return (T) new AppDirectoryRenderer(context, component.a$(VisualizationComponents.AppDirectory.class), provider, target);
