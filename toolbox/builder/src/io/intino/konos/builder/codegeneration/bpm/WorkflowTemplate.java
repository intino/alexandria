...
public class WorkflowTemplate extends Template {
	...
	public RuleSet ruleSet() {
		return new RuleSet().add(
			...
			rule().condition((trigger("process"))).output(literal("case \"")).output(mark("name")).output(literal("\": return new ")).output(mark("name", "firstUpperCase")).output(literal("(id, box);")),
