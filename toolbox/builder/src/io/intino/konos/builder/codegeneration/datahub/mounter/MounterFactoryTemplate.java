...
public class MounterFactoryTemplate extends Template {
	...
	public RuleSet ruleSet() {
		return new RuleSet().add(
				...
				rule().condition((trigger("put"))).output(literal("mounters.put(")).output(mark("name")).output(literal(".class.getCanonicalName(), java.util.List.of(")).output(mark("mounter").multiple(", ")).output(literal("));")),
