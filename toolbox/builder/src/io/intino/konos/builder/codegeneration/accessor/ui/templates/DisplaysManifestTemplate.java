...
public class DisplaysManifestTemplate extends Template {
	...
	public RuleSet ruleSet() {
		return new RuleSet().add(
			rule().condition((type("manifest"))).output(literal("import DisplayFactory from 'alexandria-ui-elements/src/displays/DisplayFactory';\n")).output(mark("display", "import").multiple("\n")).output(literal("\n")).output(mark("display", "register").multiple("\n")).output(literal("\nexport { ")).output(mark("display", "export").multiple(",")).output(literal(" }")),
			...
			rule().condition((type("display")), (trigger("register"))).output(literal("DisplayFactory.register(\"")).output(mark("name", "firstUppercase")).output(literal("\", ")).output(mark("name", "firstUppercase")).output(literal(");")),
