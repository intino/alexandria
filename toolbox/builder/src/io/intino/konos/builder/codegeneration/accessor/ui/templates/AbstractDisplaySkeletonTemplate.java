...
public class AbstractDisplaySkeletonTemplate extends Template {
	...
	public RuleSet ruleSet() {
		return new RuleSet().add(
			...
			rule().condition((allTypes("renderTag","template"))).output(literal("<UiBlock")).output(expression().output(mark("properties", "common")).output(mark("properties", "specific"))).output(literal(">")),
			...
			rule().condition((allTypes("renderTag","item"))).output(literal("<div style={{width:\"100%\",...this.props.style}}>")),
