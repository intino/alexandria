...
public class ProcessTemplate extends Template {
	...
	public RuleSet ruleSet() {
		return new RuleSet().add(
				...
				rule().condition((trigger("task"))).output(literal("protected Task ")).output(mark("name", "firstLowerCase")).output(literal("() {\n\treturn new Task(")).output(mark("taskType")).output(literal(") {\n\t\t@Override\n\t\tpublic String execute() {\n\t\t\treturn null;\n\t\t}\n\t};\n}")),
