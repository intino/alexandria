...
public class PassiveViewNotifierTemplate extends Template {
	...
	public RuleSet ruleSet() {
		return new RuleSet().add(
			...
			rule().condition((attribute("catalog")), (trigger("parenttype"))).output(literal("io.intino.alexandria.ui.displays.notifiers.CatalogNotifier")),
			rule().condition((attribute("temporaltimecatalog")), (trigger("parenttype"))).output(literal("io.intino.alexandria.ui.displays.notifiers.TemporalTimeCatalogNotifier")),
			rule().condition((attribute("temporalrangecatalog")), (trigger("parenttype"))).output(literal("io.intino.alexandria.ui.displays.notifiers.TemporalRangeCatalogNotifier")),
			rule().condition((attribute("menulayout")), (trigger("parenttype"))).output(literal("io.intino.alexandria.ui.displays.notifiers.MenuLayoutNotifier")),
			rule().condition((attribute("tablayout")), (trigger("parenttype"))).output(literal("io.intino.alexandria.ui.displays.notifiers.TabLayoutNotifier")),
