...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "properties & operation")), (condition("trigger", "common"))).add(expression().add(literal(" title=\"")).add(mark("title")).add(literal("\""))).add(expression().add(literal(" target=\"")).add(mark("target")).add(literal("\""))).add(expression().add(literal(" mode=\"")).add(mark("operationMode")).add(literal("\""))).add(expression().add(literal(" icon=\"")).add(mark("icon")).add(literal("\""))).add(expression().add(literal(" confirm=\"")).add(mark("confirm")).add(literal("\""))).add(expression().add(literal(" disabled={")).add(mark("disabled")).add(literal("}"))).add(expression().add(literal(" size=\"")).add(mark("size")).add(literal("\""))),
			...
			rule().add((condition("type", "properties & collection")), (condition("trigger", "specific"))).add(expression().add(literal(" noItemsMessage=\"")).add(mark("noItemsMessage")).add(literal("\""))).add(expression().add(literal(" pageSize={")).add(mark("pageSize")).add(literal("}"))).add(expression().add(literal(" itemHeight={")).add(mark("itemHeight")).add(literal("}"))).add(expression().add(literal(" scrollingMark={")).add(mark("scrollingMark")).add(literal("}"))).add(expression().add(literal(" navigable=\"")).add(mark("navigable")).add(literal("\""))).add(expression().add(literal(" selection=\"")).add(mark("selection")).add(literal("\""))),
			rule().add((condition("type", "properties & heading")), (condition("trigger", "specific"))).add(literal(" style={{width:\"calc(")).add(mark("width")).add(literal("% - ")).add(mark("marginSize")).add(literal("px)\",marginRight:\"10px\"")).add(expression().add(literal(",")).add(mark("marginLeft")).add(literal(":\"10px\""))).add(literal("}}")),
			rule().add((condition("type", "properties & item")), (condition("trigger", "specific"))).add(literal(" style={{width:\"calc(")).add(mark("width")).add(literal("% - ")).add(mark("marginSize")).add(literal("px)\",marginRight:\"10px\"")).add(expression().add(literal(",")).add(mark("marginLeft")).add(literal(":\"10px\""))).add(literal("}}")),
