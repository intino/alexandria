...
public class AsemedGenerationTest {
	...
	public void testAsemedMirrorGeneration() {
		...
		new FullRenderer(graph, TestUtil.settings(gen, ASEMED_MIRROR.toLowerCase()), compiledFiles).execute();
	}
	...
	public void testAsemedLocalGeneration() {
		...
		new FullRenderer(graph, TestUtil.settings(gen, ASEMED_LOCAL.toLowerCase()), compiledFiles).execute();
	}
}