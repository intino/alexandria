package io.intino.pandora.scheduling.directory;
...
public class PandoraDirectorySentinel {
	...
	public PandoraDirectorySentinel(File directory, DirectoryTask task, Event... events) {
		try {
