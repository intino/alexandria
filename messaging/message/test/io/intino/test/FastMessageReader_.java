...
public class FastMessageReader_ {
	...
	public void should_read_message_multiline2() {
		String message = "[WARNING]\n" +
				...
				"message:\n" +
				"\tG@R@34";
		Message next = new FastMessageReader(message).next();
		Assert.assertNotNull(next);
		message = "[WARNING]\n" +
				"ts: 2021-07-27T14:28:31.494323Z\n" +
				"source: io.intino.magritte.framework.loaders.ListProcessor:process\n" +
				"message:G@R@34";
		next = new FastMessageReader(message).next();
		Assert.assertNotNull(next);
	}
	...
	public void should_read_empty_content() {
		FastMessageReader messages = new FastMessageReader("");
	...
	public void should_read_messages_in_a_class_with_parent() {
		String inl = "[Teacher]\n" +
				...
				"[Teacher.Country]\n" +
				"name: Germany\n";
		FastMessageReader messages = new FastMessageReader(inl);
	...
	public void should_read_message_with_multiline_attribute1() {
		...
		Message message = new FastMessageReader(inl).next();
