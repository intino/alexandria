...
public class ActionTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "parameter")), (condition("type", "fileData")), (condition("trigger", "type"))).add(literal("public java.io.InputStream ")).add(mark("name", "SnakeCaseToCamelCase", "FirstLowerCase")).add(literal(";")),
