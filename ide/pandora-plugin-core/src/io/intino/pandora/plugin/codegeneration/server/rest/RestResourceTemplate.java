...
public class RestResourceTemplate extends Template {
	...
	public Template define() {
		add(
			rule().add((condition("type", "resource"))).add(literal("package ")).add(mark("package")).add(literal(".resources;\n\nimport java.util.List;\nimport org.siani.pandora.exceptions.*;\nimport ")).add(mark("package")).add(literal(".*;\nimport tara.magritte.Graph;\nimport org.siani.pandora.server.Resource;\nimport org.siani.pandora.server.spark.SparkManager;\n")).add(mark("schemaImport")).add(literal("\n\npublic class ")).add(mark("operation", "firstUpperCase")).add(mark("name", "firstUpperCase")).add(literal("Resource implements Resource {\n\n\tprivate Graph graph;\n\tprivate SparkManager manager;\n\n\tpublic ")).add(mark("operation", "firstUpperCase")).add(mark("name", "firstUpperCase")).add(literal("Resource(Graph graph, SparkManager manager) {\n\t\tthis.graph = graph;\n\t\tthis.manager = manager;\n\t}\n\n\tpublic void execute() throws ")).add(mark("throws").multiple(", ")).add(literal(" {\n\t\t")).add(expression().add(mark("returnType", "writeCall"))).add(literal("fill(new ")).add(mark("package", "validname")).add(literal(".actions.")).add(mark("operation", "firstUpperCase")).add(mark("name", "firstUpperCase")).add(literal("Action()).execute()")).add(expression().add(mark("returnType", "ending"))).add(literal(";\n\t}\n\n\tprivate ")).add(mark("package", "validname")).add(literal(".actions.")).add(mark("operation", "firstUpperCase")).add(mark("name", "firstUpperCase")).add(literal("Action fill(")).add(mark("package", "validname")).add(literal(".actions.")).add(mark("operation", "firstUpperCase")).add(mark("name", "firstUpperCase")).add(literal("Action action) {\n\t\taction.graph = this.graph;")).add(expression().add(literal("\n")).add(literal("\t\t")).add(mark("parameter", "assign").multiple("\n"))).add(literal("\n\t\treturn action;\n\t}\n    ")).add(expression().add(literal("\n")).add(literal("    ")).add(mark("returnType", "write"))).add(literal("\n}")),
