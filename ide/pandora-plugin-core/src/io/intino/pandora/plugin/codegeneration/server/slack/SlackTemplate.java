...
public class SlackTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "parameter & String")), (condition("trigger", "cast"))).add(literal("args")).add(expression().add(mark("pos"))),
