...
public class SlackTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "request"))).add(literal("private String ")).add(mark("name")).add(literal("(Graph graph")).add(expression().add(literal(", ")).add(mark("parameter").multiple(", "))).add(literal(") {\n\treturn \"\";\n}")),
