package io.intino.pandora.model.codegeneration.server.slack;
...
public class SlackTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "request")), (condition("trigger", "add"))).add(literal("add(\"")).add(mark("name")).add(literal("\", \"")).add(mark("description")).add(literal("\", (properties, args) -> ")).add(mark("name", "snakeCaseToCamelCase", "firstLowerCase")).add(literal("(box, properties")).add(expression().add(literal(", ")).add(mark("parameter", "cast").multiple(", "))).add(literal("));")),
			rule().add((condition("type", "request"))).add(literal("private String ")).add(mark("name", "snakeCaseToCamelCase", "firstLowerCase")).add(literal("(Box box, MessageProperties properties")).add(expression().add(literal(", ")).add(mark("parameter").multiple(", "))).add(literal(") {\n\treturn \"\";\n}")),
