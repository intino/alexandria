...
public class JMXAccessorTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "parameter")), (condition("trigger", "signature"))).add(mark("name", "SnakeCaseToCamelCase", "firstLowerCase")),
