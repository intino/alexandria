...
public class ActivityTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "display")), (condition("trigger", "provider"))).add(literal("if (display instanceof ")).add(mark("name", "firstUpperCase")).add(literal("Display) return new ")).add(mark("name", "firstUpperCase")).add(literal("DisplayNotifier(display, messageCarrier);")),
