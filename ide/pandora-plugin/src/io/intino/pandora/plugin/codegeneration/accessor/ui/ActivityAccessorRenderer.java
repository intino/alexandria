...
public class ActivityAccessorRenderer {
	...
	private void createWidgets() throws IOException {
		...
		write(new File(rooDirectory(), SRC_DIRECTORY + separator + "widgets.html").toPath(), WidgetsTemplate.create().format(widgets).getBytes());
	}
	...
	private void createStaticFiles() throws IOException {
		...
		File file = new File(root, SRC_DIRECTORY + separator + "main.js");
