...
public class RESTServiceTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("trigger", "hasNotifications"))).add(literal("if (!io.intino.konos.alexandria.rest.AlexandriaSparkBuilder.isUI()) server.route(\"/push\").push(new SparkPushService());"))
		);
		return this;
	}
}