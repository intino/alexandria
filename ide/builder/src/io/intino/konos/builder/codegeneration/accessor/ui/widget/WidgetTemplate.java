...
public class WidgetTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "prototype")), (condition("trigger", "prototype"))).add(literal("<alexandria-")).add(mark("type", "camelCaseToSnakeCase")).add(literal("></alexandria-")).add(mark("type", "camelCaseToSnakeCase")).add(literal(">")),
