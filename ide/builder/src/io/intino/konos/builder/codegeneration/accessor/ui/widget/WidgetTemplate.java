...
public class WidgetTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("trigger", "imports"))).add(literal("<script src=\"../../lib/alexandria-activity-elements/alexandria")).add(mark("type", "snakecaseToCamelCase", "lowercase")).add(literal("/requester.js\"></script>\n<script src=\"../../lib/alexandria-activity-elements/alexandria")).add(mark("type", "snakecaseToCamelCase", "lowercase")).add(literal("/notifier-listener.js\"></script>")),
