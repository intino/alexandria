...
public class SlackTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "request")), (condition("trigger", "method"))).add(literal("static ")).add(mark("responseType")).add(literal(" ")).add(mark("name", "snakeCaseToCamelCase", "firstLowerCase")).add(literal("(")).add(mark("box", "validname", "FirstUpperCase")).add(literal("Box box, MessageProperties properties")).add(expression().add(literal(", ")).add(mark("parameter").multiple(", "))).add(literal(") {\n\treturn \"\";\n}")),
