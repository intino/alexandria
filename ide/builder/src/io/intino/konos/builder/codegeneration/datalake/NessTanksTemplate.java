...
public class NessTanksTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "tank")), (condition("trigger", "subscribe"))).add(mark("name")).add(literal(".flow(clientID != null ? clientID + \"-")).add(mark("name")).add(literal("\" : null);")),
