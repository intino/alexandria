...
public class NessTanksTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "tank")), (condition("trigger", "subscribe"))).add(literal("new TopicConsumer(box.datalake().session(), ")).add(mark("name")).add(literal(").listen(new Subscriptor(box, \"flow.\" + ")).add(mark("name")).add(literal("), box.configuration().nessConfiguration().clientID + \"-")).add(mark("name")).add(literal("\");")),
