...
public class NessTanksTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "tank")), (condition("trigger", "map"))).add(mark("name")).add(literal(".flow(new ")).add(mark("name", "snakeCaseToCamelCase", "FirstUpperCase")).add(literal("Subscriptor(box), box.configuration().nessConfiguration().clientID + \"-")).add(mark("name")).add(literal("\");")),
