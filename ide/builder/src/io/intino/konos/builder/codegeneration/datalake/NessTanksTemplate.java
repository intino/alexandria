...
public class NessTanksTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "tank")), (condition("trigger", "assign"))).add(mark("name")).add(literal(" = box.datalake().tank(")).add(mark("messageType", "format")).add(literal(");\nhandlersMap.put(")).add(mark("simpleMessageType", "shortPath", "lowerCase", "quoted")).add(literal(", new ")).add(mark("name", "FirstUpperCase")).add(literal("Subscriptor(box));")),
			rule().add((condition("type", "tank")), (condition("trigger", "add"))).add(literal("tanks.add(this.")).add(mark("name")).add(literal(");")),
			...
			rule().add((condition("type", "tank")), (condition("trigger", "map"))).add(mark("name")).add(literal(".flow(new ")).add(mark("name", "snakeCaseToCamelCase", "FirstUpperCase")).add(literal("Subscriptor(box),  clientID != null ? clientID + \"-")).add(mark("name")).add(literal("\" : null);")),
			rule().add((condition("type", "tank")), (condition("trigger", "subscribe"))).add(mark("name")).add(literal(".flow(new ")).add(mark("name", "snakeCaseToCamelCase", "FirstUpperCase")).add(literal("Subscriptor(box),  clientID != null ? clientID + \"-")).add(mark("name")).add(literal("\" : null);")),
