...
public class DisplayTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("trigger", "component"))).add(literal("addAndPersonify(new ")).add(mark("value", "firstUpperCase")).add(literal("((box)));"))
		);
		return this;
	}
}