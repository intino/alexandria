...
public class DialogTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "execution"))).add(literal("public static Modification ")).add(mark("name")).add(literal("(")).add(mark("box", "SnakeCaseToCamelCase", "FirstUpperCase")).add(literal("Box box, Dialog dialog, Dialog.Toolbar.Operation self, io.intino.konos.alexandria.activity.services.push.ActivitySession session) {\n\treturn Modification.None;\n}\n")),
