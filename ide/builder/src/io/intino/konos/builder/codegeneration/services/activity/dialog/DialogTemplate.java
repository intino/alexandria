...
public class DialogTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "execution"))).add(literal("public static Modification ")).add(mark("name")).add(literal("(")).add(mark("box", "SnakeCaseToCamelCase", "FirstUpperCase")).add(literal("Box box, Dialog.Toolbar.Operation self) {\n\treturn Modification.None;\n}\n")),
