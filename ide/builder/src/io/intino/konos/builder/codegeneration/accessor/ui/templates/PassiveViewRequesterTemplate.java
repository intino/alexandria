...
public class PassiveViewRequesterTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "parameter")), (condition("trigger", "request"))).add(mark("name")).add(literal(" = function(value) {\n\t")).add(mark("method")).add(literal("({ op: \"")).add(mark("name")).add(literal("\", s: \"")).add(mark("display", "lowercase")).add(literal("\", d: this.element.props.id, v: ")).add(mark("parameter")).add(literal("});\n}")),
			rule().add((condition("trigger", "request"))).add(mark("name")).add(literal(" = (")).add(expression().add(mark("parameterSignature"))).add(literal(") => {\n    ")).add(mark("method")).add(literal("({ op: \"")).add(mark("name")).add(literal("\", s: \"")).add(mark("display", "lowercase")).add(literal("\", d: this.element.props.id")).add(expression().add(literal(", v: ")).add(mark("parameter"))).add(literal("});\n};")),
