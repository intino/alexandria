...
public class WidgetTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("trigger", "innerDisplay"))).add(literal("<div><cotton-zombie display=\"")).add(mark("value")).add(literal("Display\" widget=\"")).add(mark("value")).add(literal("\"></cotton-zombie></div>")),
			rule().add((condition("trigger", "parent"))).add(literal("<div><cotton-zombie display=\"")).add(mark("value")).add(literal("Display\" widget=\"")).add(mark("value")).add(literal("\"></cotton-zombie></div>"))
		);
		return this;
	}
}