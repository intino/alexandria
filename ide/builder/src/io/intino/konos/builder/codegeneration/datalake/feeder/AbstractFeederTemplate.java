...
public class AbstractFeederTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "poll")), (condition("trigger", "super"))).add(literal("super(\"")).add(mark("defaultOption")).add(literal("\", Arrays.asList(")).add(mark("option", "quoted").multiple(", ")).add(literal("));")),
