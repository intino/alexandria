...
public class ProcessCoordinatorTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "process")), (condition("trigger", "subscribe"))).add(mark("name", "firstLowerCase")).add(literal(".flow(clientID != null ? clientID + \"-")).add(mark("name", "lowerCase")).add(literal("\" : null);")),
