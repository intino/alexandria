...
public class NessEventsTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "messageHandler")), (condition("trigger", "topic"))).add(literal("public static final String ")).add(mark("name")).add(literal("Tank = ")).add(mark("messageType", "format")).add(literal(";")),
			rule().add((condition("type", "messageHandler")), (condition("trigger", "subscribe"))).add(literal("new TopicConsumer(box.datalake().session(), ")).add(mark("name")).add(literal("Tank).listen(new Subscriptor(box, ")).add(mark("name")).add(literal("Tank), box.configuration().nessConfiguration().clientID + \"-")).add(mark("name")).add(literal("\");")),
