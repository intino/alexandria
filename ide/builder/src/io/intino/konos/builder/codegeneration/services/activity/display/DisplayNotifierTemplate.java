...
public class DisplayNotifierTemplate extends Template {
	...
	public Template define() {
		add(
			rule().add((condition("type", "display"))).add(literal("package ")).add(mark("package", "validPackage")).add(literal(".displays.notifiers;\n\nimport io.intino.konos.alexandria.exceptions.*;\nimport ")).add(mark("package", "validPackage")).add(literal(".*;\n")).add(mark("schemaImport")).add(literal("\n\npublic class ")).add(mark("name", "FirstUpperCase")).add(literal("DisplayNotifier extends ")).add(mark("type")).add(literal(" {\n\n    public ")).add(mark("name", "FirstUpperCase")).add(literal("DisplayNotifier(io.intino.konos.alexandria.activity.displays.AlexandriaDisplay display, io.intino.konos.alexandria.activity.displays.MessageCarrier carrier) {\n        super(display, carrier);\n    }\n\n\t")).add(mark("notification").multiple("\n\n")).add(literal("\n}")),
			rule().add((condition("attribute", "display")), (condition("trigger", "type"))).add(literal("io.intino.konos.alexandria.activity.displays.AlexandriaDisplayNotifier")),
			rule().add((condition("attribute", "desktop")), (condition("trigger", "type"))).add(literal("io.intino.konos.alexandria.activity.displays.notifiers.AlexandriaDesktopDisplayNotifier")),
			rule().add((condition("attribute", "panel")), (condition("trigger", "type"))).add(literal("io.intino.konos.alexandria.activity.displays.notifiers.AlexandriaPanelDisplayNotifier")),
			rule().add((condition("attribute", "catalog")), (condition("trigger", "type"))).add(literal("io.intino.konos.alexandria.activity.displays.notifiers.AlexandriaCatalogDisplayNotifier")),
			rule().add((condition("attribute", "mold")), (condition("trigger", "type"))).add(literal("io.intino.konos.alexandria.activity.displays.notifiers.AlexandriaMoldDisplayNotifier")),
			rule().add((condition("attribute", "MenuLayout")), (condition("trigger", "type"))).add(literal("io.intino.konos.alexandria.activity.displays.notifiers.AlexandriaMenuLayoutDisplayNotifier")),
			rule().add((condition("attribute", "TabLayout")), (condition("trigger", "type"))).add(literal("io.intino.konos.alexandria.activity.displays.notifiers.AlexandriaTabLayoutDisplayNotifier")),
