...
public class DisplayNotifierTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("attribute", "layout")), (condition("trigger", "type"))).add(literal("io.intino.konos.alexandria.activity.displays.notifiers.AlexandriaLayoutDisplayNotifier")),
