...
import io.intino.konos.builder.codegeneration.services.ui.displays.renderers.DesktopRenderer;
...
public class DisplayRendererFactory {
	...
	public <T extends UIRenderer> T renderer(Settings settings, Display display) {
		if (display.i$(Desktop.class)) return (T) new DesktopRenderer(settings, display.a$(Desktop.class));
