...
public class DesktopTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "desktop & src"))).add(literal("package ")).add(mark("package")).add(literal(".displays;\n\nimport ")).add(mark("package", "validPackage")).add(literal(".")).add(mark("box", "firstUpperCase")).add(literal("Box;\nimport io.intino.konos.alexandria.activity.displays.AlexandriaLayoutDisplay;\n\npublic class ")).add(mark("name", "FirstUpperCase")).add(literal("Home extends Abstract")).add(mark("name", "FirstUpperCase")).add(literal("Home {\n\n    public ")).add(mark("name", "FirstUpperCase")).add(literal("Home(")).add(mark("box", "FisrtUpperCase")).add(literal("Box box) {\n        super(box);\n    }\n\n    public static class Layout {\n        public static AlexandriaLayoutDesktop layoutHome(")).add(mark("box", "FisrtUpperCase")).add(literal("Box box) {\n            return new ")).add(mark("name", "FirstUpperCase")).add(literal("Menu(box);\n        }\n    }\n}"))
		);
		return this;
	}
}