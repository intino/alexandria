...
public class ResourceTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "polymer"))).add(literal("Polymer({\n\tis: 'page-body'\n});"))
		);
		return this;
	}
}