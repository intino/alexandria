...
public class AbstractDisplaySkeletonTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("attribute", "abstract")), (condition("trigger", "import"))).add(literal("import Ui")).add(mark("value", "firstUpperCase")).add(literal(" from \"../../lib/alexandria-ui-elements/src/displays/")).add(mark("value", "firstUpperCase")).add(literal("\"")),
