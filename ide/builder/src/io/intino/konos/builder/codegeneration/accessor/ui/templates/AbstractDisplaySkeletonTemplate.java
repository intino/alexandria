...
public class AbstractDisplaySkeletonTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "renderTag & mold")), (condition("trigger", "end"))).add(literal("</Ui.Block>")),
			rule().add((condition("type", "renderTag & block")), (condition("trigger", "end"))).add(literal("</Ui.Block>")),
			rule().add((condition("type", "renderTag & mold"))).add(literal("<Ui.Block")).add(expression().add(mark("properties", "common")).add(mark("properties", "specific"))).add(literal(">")),
