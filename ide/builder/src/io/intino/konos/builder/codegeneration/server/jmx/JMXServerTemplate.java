...
public class JMXServerTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "operation")), (condition("trigger", "signature"))).add(mark("returnType")).add(literal(" ")).add(mark("name", "SnakeCaseToCamelCase", "firstLowerCase")).add(literal("(")).add(mark("parameter", "withType").multiple(", ")).add(literal(");")),
