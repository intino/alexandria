...
public class PassiveViewNotifierTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("attribute", "root")), (condition("trigger", "parentType"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaRootNotifier")),
			rule().add((condition("attribute", "editor")), (condition("trigger", "parentType"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaEditorNotifier")),
			rule().add((condition("attribute", "desktop")), (condition("trigger", "parentType"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaDesktopNotifier")),
			...
			rule().add((condition("attribute", "component")), (condition("trigger", "parentType"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaComponentNotifier")),
			rule().add((condition("attribute", "display")), (condition("trigger", "parentType"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaDisplayNotifier")),
