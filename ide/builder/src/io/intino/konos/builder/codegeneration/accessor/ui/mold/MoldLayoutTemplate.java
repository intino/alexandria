...
public class MoldLayoutTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "stamp")), (condition("trigger", "style"))).add(literal(":host .")).add(mark("name")).add(literal(" { @apply(--")).add(mark("name")).add(literal("); }")),
			rule().add((condition("type", "block")), (condition("trigger", "style"))).add(literal(":host .")).add(mark("name")).add(literal(" { @apply(--")).add(mark("name")).add(literal("); }")).add(expression().add(literal("\n")).add(mark("block", "style").multiple("\n"))),
