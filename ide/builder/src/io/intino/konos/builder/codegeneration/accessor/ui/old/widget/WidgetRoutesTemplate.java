package io.intino.konos.builder.codegeneration.accessor.ui.old.widget;
...
public class WidgetRoutesTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "listenForChanges")), (condition("trigger", "onChanged"))).add(literal("else if (this._isRoute(path, this._path + \"")).add(mark("value", "subpath")).add(literal("\")) this.route")).add(mark("request", "FirstUpperCase")).add(literal("(this.display, ")).add(mark("routePath", "call")).add(literal(");")),
			rule().add((condition("trigger", "onChanged"))),
