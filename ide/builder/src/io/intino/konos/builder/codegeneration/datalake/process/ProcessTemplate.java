...
public class ProcessTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("trigger", ""))).add(literal("\"")).add(mark("value")).add(literal("\""))
		);
		return this;
	}
}