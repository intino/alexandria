...
public class ProcessTemplate extends Template {
	...
	public Template define() {
		add(
			rule().add((condition("type", "process"))).add(literal("package ")).add(mark("package", "validPackage")).add(literal(".ness.processes;\n\nimport ")).add(mark("package", "validPackage")).add(literal(".")).add(mark("box", "firstUpperCase")).add(literal("Box;\nimport io.intino.ness.inl.Message;\n\npublic class ")).add(mark("name", "FirstUpperCase")).add(literal("Process {\n\n\tpublic ")).add(mark("box", "validName", "firstUpperCase")).add(literal("Box box;\n\tpublic ")).add(mark("type", "typeClass")).add(literal(" ")).add(mark("type", "typeName")).add(literal(";\n\n\t")).add(mark("precondition")).add(literal("\n\n\tpublic void execute() {\n\t}\n}")),
			rule().add((condition("trigger", "precondition"))).add(literal("public boolean ")).add(mark("name", "firstLowerCase")).add(literal("(")).add(mark("type", "typeClass")).add(literal(" ")).add(mark("type", "typeName")).add(literal(") {\n\treturn true;\n}")),
