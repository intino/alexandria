...
public class AbstractDisplaySkeletonTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "attribute")), (condition("trigger", "declaration"))).add(literal("private ")).add(mark("clazz")).add(literal(" ")).add(mark("name", "firstLowerCase")).add(literal(";")),
			rule().add((condition("type", "attribute")), (condition("trigger", "getterSetter"))).add(literal("public ")).add(mark("clazz")).add(literal(" get")).add(mark("name", "firstUpperCase")).add(literal("() {\n\treturn this.")).add(mark("name", "firstLowerCase")).add(literal(";\n}\npublic void set")).add(mark("name", "firstUpperCase")).add(literal("(")).add(mark("clazz")).add(literal(" ")).add(mark("name", "firstLowerCase")).add(literal(") {\n\tthis.")).add(mark("name", "firstLowerCase")).add(literal(" = ")).add(mark("name", "firstLowerCase")).add(literal(";\n}"))
		);
		return this;
	}
}