...
public class AbstractDisplaySkeletonTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "componentReferences & forTemplate"))).add(mark("component", "templateReferences").multiple("\n")),
