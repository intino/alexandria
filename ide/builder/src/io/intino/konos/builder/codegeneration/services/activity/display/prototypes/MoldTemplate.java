...
public class MoldTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "stamp & taskOperation"))).add(literal("public static class ")).add(mark("name", "FirstUpperCase")).add(literal(" {\n\t")).add(mark("common")).add(literal("\n\n\tpublic static io.intino.konos.alexandria.activity.model.mold.stamps.operations.TaskOperation.Refresh execute(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", ActivitySession session) {\n\t\treturn io.intino.konos.alexandria.activity.model.mold.stamps.operations.TaskOperation.Refresh.None;\n\t}\n}")),
			...
			rule().add((condition("trigger", "embeddedCatalogFilter"))).add(literal("public static boolean filter(")).add(mark("box")).add(literal("Box box, io.intino.konos.alexandria.activity.model.Element element, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(" source, Object target, ActivitySession session) {\n\treturn true;//TODO\n}")),
