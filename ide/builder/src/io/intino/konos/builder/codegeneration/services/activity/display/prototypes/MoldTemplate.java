...
public class MoldTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("trigger", "common"))).add(literal("public static ")).add(mark("valueType")).add(literal(" value(")).add(mark("moldType")).add(literal(" station, String username) {\n\treturn null;//TODO\n}\n\npublic static String style(")).add(mark("moldType")).add(literal(" station, String username) {\n\treturn \"\";//TODO\n}")),
			rule().add((condition("trigger", "property"))).add(literal("public static ")).add(mark("returnType")).add(literal(" ")).add(mark("name")).add(literal("(")).add(mark("moldType")).add(literal(" station, String username) {\n\treturn null;//TODO\n}"))
		);
		return this;
	}
}