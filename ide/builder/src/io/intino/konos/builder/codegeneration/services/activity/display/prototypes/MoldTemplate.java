...
public class MoldTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "stamp & taskOperation")), (condition("trigger", "class"))).add(literal("public static class ")).add(mark("name", "FirstUpperCase")).add(literal(" {\n\t")).add(mark("common")).add(literal("\n\n\tpublic static io.intino.konos.alexandria.activity.Resource execute(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", String username) {\n\t\treturn null;//TODO\n\t}\n}")),
			...
			rule().add((condition("type", "stamp & display")), (condition("trigger", "class"))).add(literal("public static class ")).add(mark("name", "FirstUpperCase")).add(literal(" {\n\t")).add(mark("common")).add(literal("\n\n\t")).add(mark("displayBuilder")).add(literal("\n}")),
			...
			rule().add((condition("trigger", "embeddedCatalogFilter"))).add(literal("public static boolean filter(")).add(mark("box")).add(literal("Box box, io.intino.konos.alexandria.activity.model.Element element, Object source, Object target, String username) {\n\treturn true;//TODO\n}")),
			rule().add((condition("trigger", "filter"))).add(literal("public static boolean filter(")).add(mark("box")).add(literal("Box box, Object source, Object target, String username) {\n\treturn true;//TODO\n}")),
			...
			rule().add((condition("trigger", "property"))).add(literal("public static ")).add(mark("returnType")).add(literal(" ")).add(mark("name")).add(literal("(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", String username) {\n\treturn null;//TODO\n}")),
