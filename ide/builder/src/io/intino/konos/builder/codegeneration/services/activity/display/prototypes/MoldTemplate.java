...
public class MoldTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "stamp & downloadOperation"))).add(literal("public static class ")).add(mark("name", "FirstUpperCase")).add(literal(" {\n\t")).add(mark("common")).add(literal("\n\n\tpublic static io.intino.konos.alexandria.activity.Resource execute(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", String option, User user) {\n\t\treturn null;//TODO\n\t}\n}")),
			rule().add((condition("type", "stamp & previewOperation"))).add(literal("public static class ")).add(mark("name", "FirstUpperCase")).add(literal(" {\n\t")).add(mark("common")).add(literal("\n\n\tpublic static java.net.URL preview(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", User user) {\n\t\treturn null;//TODO\n\t}\n}")),
			rule().add((condition("type", "stamp & exportOperation"))).add(literal("public static class ")).add(mark("name", "FirstUpperCase")).add(literal(" {\n\t")).add(mark("common")).add(literal("\n\n\tpublic static io.intino.konos.alexandria.activity.Resource execute(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", java.time.Instant from, java.time.Instant to, String option, User user) {\n\t\treturn null;//TODO\n\t}\n}")),
			rule().add((condition("type", "stamp & taskOperation"))).add(literal("public static class ")).add(mark("name", "FirstUpperCase")).add(literal(" {\n\t")).add(mark("common")).add(literal("\n\n\tpublic static void execute(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", User user) {\n\n\t}\n}")),
			rule().add((condition("type", "stamp & location"))).add(literal("public static class ")).add(mark("name", "FirstUpperCase")).add(literal(" {\n\t")).add(mark("common")).add(literal("\n\n\tpublic static java.net.URL icon(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", User user) {\n\t\treturn null;//TODO\n\t}\n\n\tpublic static String drawingColor(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", User user) {\n\t\treturn null;//TODO\n\t}\n}")),
			...
			rule().add((condition("type", "stamp & highlight"))).add(literal("public static class ")).add(mark("name", "FirstUpperCase")).add(literal(" {\n\t")).add(mark("common")).add(literal("\n\n\tpublic static String color(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", User user) {\n\t\treturn \"\";//TODO\n\t}\n}")),
			...
			rule().add((condition("type", "stamp & icon"))).add(literal("public static class ")).add(mark("name", "FirstUpperCase")).add(literal(" {\n\t")).add(mark("common")).add(literal("\n\n\tpublic static String title(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", User user) {\n\t\treturn \"\";//TODO\n\t}\n}")),
			...
			rule().add((condition("trigger", "style"))).add(literal("public static String style(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", User user) {\n\treturn \"\";//TODO\n}")),
			rule().add((condition("trigger", "embeddedCatalogFilter"))).add(literal("public static boolean filter(")).add(mark("box")).add(literal("Box box, io.intino.konos.alexandria.activity.model.Element element, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(" source, Object target, User user) {\n\treturn true;//TODO\n}")),
			rule().add((condition("trigger", "filter"))).add(literal("public static boolean filter(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", Object target, User user) {\n\treturn true;//TODO\n}")),
			rule().add((condition("trigger", "displayBuilder"))).add(literal("public static io.intino.konos.alexandria.activity.displays.AlexandriaStamp buildDisplay(")).add(mark("box")).add(literal("Box box, String name, User user) {\n\treturn null;//TODO\n}")),
			rule().add((condition("trigger", "editable"))).add(literal("public static io.intino.konos.alexandria.activity.model.mold.Stamp.Editable.Refresh onChange(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", String value, User user) {\n\treturn null;\n}")),
			rule().add((condition("trigger", "valueMethod"))).add(literal("public static ")).add(mark("valueType")).add(literal(" value(")).add(mark("box")).add(literal("Box box, ")).add(mark("moldClass")).add(literal(" ")).add(mark("moldClass", "shortType", "firstLowerCase")).add(literal(", User user) {\n\treturn null;//TODO\n}")),
