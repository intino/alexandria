...
public class DisplayNotifierTemplate extends Template {
	...
	public Template define() {
		add(
				...
				rule().add((condition("attribute", "display")), (condition("trigger", "type"))).add(literal("io.intino.alexandria.ui.displays.AlexandriaDisplayNotifier")),
				rule().add((condition("attribute", "desktop")), (condition("trigger", "type"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaDesktopNotifier")),
				rule().add((condition("attribute", "panel")), (condition("trigger", "type"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaPanelNotifier")),
				rule().add((condition("attribute", "catalog")), (condition("trigger", "type"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaCatalogNotifier")),
				rule().add((condition("attribute", "temporalTimeCatalog")), (condition("trigger", "type"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaTemporalTimeCatalogNotifier")),
				rule().add((condition("attribute", "temporalRangeCatalog")), (condition("trigger", "type"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaTemporalRangeCatalogNotifier")),
				rule().add((condition("attribute", "editor")), (condition("trigger", "type"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaEditorNotifier")),
				rule().add((condition("attribute", "mold")), (condition("trigger", "type"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaMoldNotifier")),
				rule().add((condition("attribute", "MenuLayout")), (condition("trigger", "type"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaMenuLayoutNotifier")),
				rule().add((condition("attribute", "TabLayout")), (condition("trigger", "type"))).add(literal("io.intino.alexandria.ui.displays.notifiers.AlexandriaTabLayoutNotifier")),
