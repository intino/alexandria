...
public class AbstractMoldTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("trigger", "common"))).add(expression().add(literal(".name(\"")).add(mark("name")).add(literal("\")"))).add(expression().add(literal(".label(\"")).add(mark("label")).add(literal("\")"))).add(expression().add(literal(".defaultStyle(\"")).add(mark("defaultStyle")).add(literal("\")"))).add(expression().add(literal(".layout(Stamp.Layout.")).add(mark("layout")).add(literal(")"))).add(expression().add(mark("style"))).add(literal(".value((object, username) -> ")).add(mark("mold", "FirstUpperCase")).add(literal("Mold.Stamps.")).add(mark("name", "FirstUpperCase")).add(literal(".value((")).add(mark("moldType")).add(literal(") object, username))")),
			rule().add((condition("trigger", "style"))).add(literal(".style((object, username) -> ")).add(mark("mold", "FirstUpperCase")).add(literal("Mold.Stamps.")).add(mark("name", "firstUpperCase")).add(literal(".style((")).add(mark("moldType")).add(literal(") object, username))")),
