...
public class AbstractMoldTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "block")), (condition("trigger", "definition"))).add(literal(".add(new Block()")).add(expression().add(literal(".name(\"")).add(mark("name")).add(literal("\")"))).add(expression().add(mark("expanded"))).add(expression().add(mark("layout").multiple(""))).add(expression().add(mark("height"))).add(expression().add(mark("style"))).add(expression().add(literal("\n")).add(literal("\t")).add(mark("stamp").multiple("\n\t\t"))).add(expression().add(literal("\n")).add(literal("\t")).add(mark("block", "definition").multiple("\n"))).add(literal(")\n")),
			...
			rule().add((condition("type", "stamp & highlight"))).add(literal(".add(new Highlight().color((object, username) -> ")).add(mark("mold", "FirstUpperCase")).add(literal("Mold.Stamps.")).add(mark("name", "FirstUpperCase")).add(literal(".color((")).add(mark("moldType")).add(literal(") object, username))")).add(mark("common")).add(literal(")")),
			...
			rule().add((condition("type", "stamp & operation"))).add(literal(".add(new io.intino.konos.alexandria.activity.model.mold.stamps.operations.")).add(mark("operationType")).add(literal("Operation().path((object, username) -> ")).add(mark("mold", "FirstUpperCase")).add(literal("Mold.Stamps.")).add(mark("name", "FirstUpperCase")).add(literal(".path((")).add(mark("moldType")).add(literal(") object, username)))")),
			...
			rule().add((condition("trigger", "common"))).add(expression().add(literal(".name(\"")).add(mark("name")).add(literal("\")"))).add(expression().add(literal(".label(\"")).add(mark("label")).add(literal("\")"))).add(expression().add(literal(".defaultStyle(\"")).add(mark("defaultStyle")).add(literal("\")"))).add(expression().add(literal(".layout(Stamp.Layout.")).add(mark("layout")).add(literal(")"))).add(literal(".style((object, username) -> ")).add(mark("mold", "FirstUpperCase")).add(literal("Mold.Stamps.")).add(mark("name", "firstUpperCase")).add(literal(".style((")).add(mark("moldType")).add(literal(") object, username)).value((object, username) -> ")).add(mark("mold", "FirstUpperCase")).add(literal("Mold.Stamps.")).add(mark("name", "FirstUpperCase")).add(literal(".value((")).add(mark("moldType")).add(literal(") object, username))")),
			rule().add((condition("trigger", "icon"))).add(literal(".icon((object, username) -> ")).add(mark("mold", "FirstUpperCase")).add(literal("Mold.Stamps.")).add(mark("name", "FirstUpperCase")).add(literal(".icon((")).add(mark("moldType")).add(literal(") object, username))")),
