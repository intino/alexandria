...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "reference"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("((")).add(mark("box", "firstUpperCase")).add(literal("Box)box()).id(\"")).add(mark("id")).add(literal("\").owner(")).add(mark("owner", "firstUpperCase")).add(literal(".this));")),
			rule().add((condition("type", "component & child & instanceBlock")), (condition("trigger", "declarations"))).add(literal("public ")).add(mark("instanceBlockName", "firstUpperCase")).add(literal(" ")).add(mark("name")).add(literal(";")),
			...
			rule().add((condition("type", "component & child & instanceBlock")), (condition("trigger", "declaration"))).add(literal("public ")).add(mark("instanceBlockName", "firstUpperCase")).add(literal(" ")).add(mark("name")).add(literal(";")),
			...
			rule().add((condition("type", "component & child & instanceBlock")), (condition("trigger", "class"))),
			...
			rule().add((condition("type", "extends & blockInstance"))).add(mark("type", "firstUpperCase")),
			...
			rule().add((condition("type", "component & child")), (condition("trigger", "blockReferences"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("(box()).id(\"")).add(mark("id")).add(literal("\").owner(")).add(mark("owner", "firstUpperCase")).add(literal(".this));")).add(expression().add(literal("\n")).add(mark("component", "blockChildReferences").multiple("\n"))),
			rule().add((condition("type", "component & child")), (condition("trigger", "references"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("(box()).id(\"")).add(mark("id")).add(literal("\").owner(")).add(mark("owner", "firstUpperCase")).add(literal(".this));")).add(expression().add(literal("\n")).add(mark("component", "childReferences").multiple("\n"))),
			...
			rule().add((condition("type", "component & child & instanceBlock"))).add(mark("name")).add(literal(" = register(new ")).add(mark("instanceBlockName", "firstUpperCase")).add(literal("((")).add(mark("box", "firstUpperCase")).add(literal("Box)box())")).add(mark("properties", "common")).add(mark("properties", "specific")).add(literal(".id(\"")).add(mark("id")).add(literal("\"));")),
			rule().add((condition("type", "component & child"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("(box())")).add(mark("properties", "common")).add(mark("properties", "specific")).add(literal(".id(\"")).add(mark("id")).add(literal("\").owner(")).add(mark("owner", "firstUpperCase")).add(literal(".this));")),
