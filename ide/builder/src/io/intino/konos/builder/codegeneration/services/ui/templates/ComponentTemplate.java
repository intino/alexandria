...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "component & child & collectableblock")), (condition("trigger", "declarations"))).add(literal("public ")).add(mark("mold", "firstUpperCase")).add(literal(" ")).add(mark("name")).add(literal(";")),
			...
			rule().add((condition("type", "component & child & collectableblock")), (condition("trigger", "declaration"))).add(literal("public ")).add(mark("mold", "firstUpperCase")).add(literal(" ")).add(mark("name")).add(literal(";")),
			...
			rule().add((condition("type", "component & child & collectableblock & withMold")), (condition("trigger", "method"))).add(literal("public void addAll(java.util.List<")).add(mark("modelClass")).add(literal("> items) {\n\titems.forEach(this::add);\n}\n\npublic void add(")).add(mark("modelClass")).add(literal(" item) {\n\t")).add(mark("mold", "firstUpperCase")).add(literal(" mold = new ")).add(mark("mold", "firstUpperCase")).add(literal("((")).add(mark("box", "firstUpperCase")).add(literal("Box)box());\n\tmold.id(java.util.UUID.randomUUID().toString());\n\tmold.item = item;\n\t")).add(mark("owner")).add(literal(".this.add(mold, \"items\");\n}")),
			...
			rule().add((condition("type", "component & child & collectableblock")), (condition("trigger", "class"))),
			...
			rule().add((condition("type", "extends & collectableblock"))).add(mark("type", "firstUpperCase")),
			...
			rule().add((condition("type", "component & child & collectableblock"))).add(literal("if(")).add(mark("name")).add(literal(" == null) ")).add(mark("name")).add(literal(" = register(new ")).add(mark("mold", "firstUpperCase")).add(literal("((")).add(mark("box", "firstUpperCase")).add(literal("Box)box()).id(\"")).add(mark("id")).add(literal("\"));")),
