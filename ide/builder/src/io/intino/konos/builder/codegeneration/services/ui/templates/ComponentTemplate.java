...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "reference"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("((")).add(mark("box", "firstUpperCase")).add(literal("Box)box()).id(\"")).add(mark("id")).add(literal("\").owner(")).add(mark("owner")).add(literal(".this));")),
			...
			rule().add((condition("type", "component & child")), (condition("trigger", "blockReferences"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("(box()).id(\"")).add(mark("id")).add(literal("\").owner(")).add(mark("owner")).add(literal(".this));")).add(expression().add(literal("\n")).add(mark("component", "blockChildReferences").multiple("\n"))),
			rule().add((condition("type", "component & child")), (condition("trigger", "references"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("(box()).id(\"")).add(mark("id")).add(literal("\").owner(")).add(mark("owner")).add(literal(".this));")).add(expression().add(literal("\n")).add(mark("component", "childReferences").multiple("\n"))),
			...
			rule().add((condition("type", "component & child"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("(box())")).add(mark("properties", "common")).add(mark("properties", "specific")).add(literal(".id(\"")).add(mark("id")).add(literal("\").owner(")).add(mark("owner")).add(literal(".this));")),
