...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "method & multiple"))).add(literal("@Override\npublic void add(")).add(mark("objectType")).add(literal(" value) {\n\tio.intino.alexandria.ui.displays.components.")).add(mark("componentType")).add(literal(" child = new io.intino.alexandria.ui.displays.components.")).add(mark("componentType")).add(literal("(box());\n\tchild.id(java.util.UUID.randomUUID().toString());\n\tadd(child, \"")).add(mark("name")).add(literal("\");\n\tchild.update(value);\n}")),
			rule().add((condition("type", "method & collection"))).add(literal("@Override\npublic void add(")).add(mark("modelClass")).add(literal(" item) {\n\t")).add(mark("mold", "firstUpperCase")).add(literal(" mold = new ")).add(mark("mold", "firstUpperCase")).add(literal("((")).add(mark("box", "firstUpperCase")).add(literal("Box)box());\n\tmold.id(java.util.UUID.randomUUID().toString());\n\tmold.item = item;\n\taddPromise(mold);\n}")),
			...
			rule().add((condition("type", "extends & multiple"))).add(literal("io.intino.alexandria.ui.displays.components.Multiple<")).add(mark("abstractBox", "type")).add(literal(", io.intino.alexandria.ui.displays.components.")).add(mark("componentType")).add(literal(", ")).add(mark("objectType")).add(literal(">")),
			rule().add((condition("type", "extends & collection"))).add(literal("io.intino.alexandria.ui.displays.components.")).add(mark("type", "firstUpperCase")).add(mark("facet")).add(literal("<")).add(mark("abstractBox", "type")).add(literal(", ")).add(mark("modelClass")).add(literal(">")),
			...
			rule().add((condition("type", "component & child & moldableblock & multipleblock")), (condition("trigger", "childReferences"))),
			...
			rule().add((condition("type", "implements & timeconsumingmold"))).add(literal("implements io.intino.alexandria.ui.displays.components.mold.TimeConsuming")),
			...
			rule().add((condition("type", "properties & openpage")), (condition("trigger", "specific"))).add(literal("title(\"")).add(mark("title")).add(literal("\");")).add(expression().add(literal("\n")).add(literal("path(\"")).add(mark("path")).add(literal("\");"))),
			...
			rule().add((condition("type", "properties & collection")), (condition("trigger", "specific"))).add(literal("source(new io.intino.alexandria.ui.sources.")).add(mark("source", "firstUpperCase")).add(literal("());\npageSize(")).add(mark("pageSize")).add(literal(");")),
