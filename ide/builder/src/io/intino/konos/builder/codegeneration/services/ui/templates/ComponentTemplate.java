...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "properties & collection")), (condition("trigger", "specific"))).add(literal("source(\"")).add(mark("source")).add(literal("\");\npageSize(\"")).add(mark("pageSize")).add(literal("\");")),
