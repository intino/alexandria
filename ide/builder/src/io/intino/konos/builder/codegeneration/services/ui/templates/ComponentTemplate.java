...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "reference"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("((")).add(mark("box", "firstUpperCase")).add(literal("Box)box()).id(\"")).add(mark("id")).add(literal("\"));")),
			...
			rule().add((condition("type", "block & child")), (condition("trigger", "references"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("(box()).id(\"")).add(mark("id")).add(literal("\"));")).add(expression().add(literal("\n")).add(mark("component", "blockChildReferences").multiple("\n"))),
