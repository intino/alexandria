...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "component & child & moldable & multiple")), (condition("trigger", "declarations"))).add(literal("public java.util.List<")).add(mark("blockName", "firstUpperCase")).add(literal("> ")).add(mark("name")).add(literal(";")),
			rule().add((condition("type", "component & child & moldable")), (condition("trigger", "declarations"))).add(literal("public ")).add(mark("blockName", "firstUpperCase")).add(literal(" ")).add(mark("name")).add(literal(";")),
			...
			rule().add((condition("type", "component & child & moldable & multiple")), (condition("trigger", "declaration"))).add(literal("public java.util.List<")).add(mark("blockName", "firstUpperCase")).add(literal("> ")).add(mark("name")).add(literal(";")),
			rule().add((condition("type", "component & child & moldable")), (condition("trigger", "declaration"))).add(literal("public ")).add(mark("blockName", "firstUpperCase")).add(literal(" ")).add(mark("name")).add(literal(";")),
			...
			rule().add((condition("type", "component & child & moldable & multiple")), (condition("trigger", "method"))).add(literal("public void add")).add(mark("name", "firstUpperCase")).add(literal("(")).add(mark("blockType", "firstUpperCase")).add(literal(" instance) {\n\tinstance.id(java.util.UUID.randomUUID().toString());\n\t")).add(mark("owner")).add(literal(".this.add(instance, \"")).add(mark("name")).add(literal("\");\n}")),
			rule().add((condition("type", "component & child")), (condition("trigger", "method"))),
			rule().add((condition("type", "component & child & moldable & multiple")), (condition("trigger", "class"))),
			rule().add((condition("type", "component & child & moldable")), (condition("trigger", "class"))),
			...
			rule().add((condition("type", "extends & moldable"))).add(mark("type", "firstUpperCase")),
			...
			rule().add((condition("type", "component & child & moldable & multiple"))).add(mark("name")).add(literal(" = new java.util.ArrayList<>();")),
			rule().add((condition("type", "component & child & moldable"))).add(mark("name")).add(literal(" = register(new ")).add(mark("blockName", "firstUpperCase")).add(literal("((")).add(mark("box", "firstUpperCase")).add(literal("Box)box())")).add(mark("properties", "common")).add(mark("properties", "specific")).add(literal(".id(\"")).add(mark("id")).add(literal("\"));")),
