...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "component & child & moldableblock"))).add(mark("name")).add(literal(" = register(new ")).add(mark("mold", "firstUpperCase")).add(literal("((")).add(mark("box", "firstUpperCase")).add(literal("Box)box()).id(\"")).add(mark("id")).add(literal("\"));")),
			rule().add((condition("type", "component & child"))).add(mark("name")).add(literal(" = register(new ")).add(mark("name", "firstUpperCase")).add(literal("(box()).<")).add(mark("name", "firstUpperCase")).add(literal(">id(\"")).add(mark("id")).add(literal("\").owner(")).add(mark("owner")).add(literal(".this));")),
