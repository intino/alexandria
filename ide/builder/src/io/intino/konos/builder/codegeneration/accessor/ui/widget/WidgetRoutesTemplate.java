...
public class WidgetRoutesTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("trigger", "onChanged"))).add(literal("else if (this._isRoute(path, \"")).add(mark("value", "subpath")).add(literal("\")) this.route")).add(mark("request", "FirstUpperCase")).add(literal("(this.display, ")).add(mark("routePath", "call")).add(literal(");")),
			...
			rule().add((condition("type", "route")), (condition("trigger", "define"))).add(literal("<app-route route=\"{{route}}\" pattern=\"")).add(mark("value")).add(literal("\" data=\"{{")).add(mark("request")).add(literal("RouteData}}\"></app-route>")),
			rule().add((condition("type", "routePath & encoded")), (condition("trigger", "call"))).add(literal("window.atob(path.replace(\"")).add(mark("value", "subpath")).add(literal("enc:\",\"\"))")),
			rule().add((condition("type", "routePath & encoded")), (condition("trigger", "register"))).add(literal("\"")).add(mark("value", "subpath")).add(literal("\" + \"enc:\" + window.btoa(value)")),
			rule().add((condition("type", "routePath")), (condition("trigger", "call"))).add(literal("path.replace(\"")).add(mark("value", "subpath")).add(literal("\",\"\")")),
			rule().add((condition("type", "routePath")), (condition("trigger", "register"))).add(literal("\"")).add(mark("value", "subpath")).add(literal("\" + value"))
		);
		return this;
	}
}