...
public class DisplaysManifestTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "mold")), (condition("trigger", "import"))).add(literal("import ")).add(mark("name", "firstUppercase")).add(literal(" from \"../")).add(mark("directory")).add(literal("/displays/molds/")).add(mark("name", "firstUppercase")).add(literal("\"")),
