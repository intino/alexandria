...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "properties")), (condition("trigger", "common"))).add(expression().add(literal(" label=\"")).add(mark("label")).add(literal("\""))).add(expression().add(literal(" format=\"")).add(mark("format").multiple(" ")).add(literal("\""))).add(expression().add(literal(" multiple={{instances:\"")).add(mark("instances")).add(literal("\",layout:\"")).add(mark("multipleLayout")).add(literal("\"}}"))),
