...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "component & child & stampblock & multipleblock"))).add(literal("{this.renderInstances(\"")).add(mark("name")).add(literal("\"")).add(expression().add(literal(", { noItemsMessage: \"")).add(mark("noItemsMessage")).add(literal("\" }"))).add(literal(")}")),
			...
			rule().add((condition("type", "extends & stampblock"))).add(literal("Displays.")).add(mark("type", "firstUpperCase")),
			...
			rule().add((condition("type", "properties")), (condition("trigger", "common"))).add(expression().add(literal(" label=\"")).add(mark("label")).add(literal("\""))).add(expression().add(literal(" format=\"")).add(mark("format").multiple(" ")).add(literal("\""))).add(expression().add(literal(" multiple={{instances:\"")).add(mark("instances")).add(literal("\",layout:\"")).add(mark("multipleLayout")).add(literal("\"}}"))).add(expression().add(literal(" color=\"")).add(mark("color")).add(literal("\""))),
			...
			rule().add((condition("type", "properties & block")), (condition("trigger", "specific"))).add(expression().add(literal(" layout=\"")).add(mark("layout").multiple(" ")).add(literal("\""))).add(expression().add(literal(" width=\"")).add(mark("width")).add(literal("\""))).add(expression().add(literal(" height=\"")).add(mark("height")).add(literal("\""))).add(expression().add(literal(" spacing=\"")).add(mark("spacing")).add(literal("\""))).add(expression().add(literal(" collapsible=\"")).add(mark("collapsible")).add(literal("\""))).add(expression().add(literal(" stamp=\"")).add(mark("stamp")).add(literal("\""))).add(expression().add(literal(" ")).add(mark("paper"))).add(expression().add(literal(" ")).add(mark("badge"))),
			...
			rule().add((condition("type", "properties & codeText")), (condition("trigger", "specific"))).add(expression().add(literal(" mode=\"")).add(mark("mode")).add(literal("\""))).add(expression().add(literal(" language=\"")).add(mark("language")).add(literal("\""))).add(expression().add(literal(" highlight=")).add(mark("highlight"))),
			rule().add((condition("type", "properties & text")), (condition("trigger", "specific"))).add(expression().add(literal(" mode=\"")).add(mark("mode")).add(literal("\""))).add(expression().add(literal(" prefix=\"")).add(mark("prefix")).add(literal("\""))).add(expression().add(literal(" suffix=\"")).add(mark("suffix")).add(literal("\""))).add(expression().add(literal(" value=\"")).add(mark("defaultValue")).add(literal("\""))).add(expression().add(literal(" highlight={")).add(mark("highlight")).add(literal("}"))),
			...
			rule().add((condition("type", "properties & collection")), (condition("trigger", "specific"))).add(expression().add(literal(" noItemsMessage=\"")).add(mark("noItemsMessage")).add(literal("\""))).add(expression().add(literal(" pageSize={")).add(mark("pageSize")).add(literal("}"))),
			...
			rule().add((condition("type", "highlight"))).add(literal("{text:\"")).add(mark("text")).add(literal("\",background:\"")).add(mark("background")).add(literal("\"}"))
		);
		return this;
	}
}