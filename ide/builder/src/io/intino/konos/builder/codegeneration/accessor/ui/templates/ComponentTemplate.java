...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "properties & text")), (condition("trigger", "specific"))).add(expression().add(literal(" mode=\"")).add(mark("mode")).add(literal("\""))).add(expression().add(literal(" prefix=\"")).add(mark("prefix")).add(literal("\""))).add(expression().add(literal(" suffix=\"")).add(mark("suffix")).add(literal("\""))).add(expression().add(literal(" value=\"")).add(mark("defaultValue")).add(literal("\""))),
			...
			rule().add((condition("type", "badge"))).add(literal("mode=\"")).add(mark("mode")).add(literal("\"")).add(expression().add(literal(" value=")).add(mark("value"))).add(expression().add(literal(" max=")).add(mark("max"))).add(expression().add(literal(" showZero=")).add(mark("showZero"))),
