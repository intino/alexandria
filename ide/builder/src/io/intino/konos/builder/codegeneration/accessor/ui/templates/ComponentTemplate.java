...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "properties & operation")), (condition("trigger", "common"))).add(expression().add(literal(" title=\"")).add(mark("title")).add(literal("\""))).add(expression().add(literal(" target=\"")).add(mark("target")).add(literal("\""))).add(expression().add(literal(" mode=\"")).add(mark("operationMode")).add(literal("\""))).add(expression().add(literal(" icon=\"")).add(mark("icon")).add(literal("\""))).add(expression().add(literal(" confirm=\"")).add(mark("confirm")).add(literal("\""))).add(expression().add(literal(" disabled={")).add(mark("disabled")).add(literal("}"))),
