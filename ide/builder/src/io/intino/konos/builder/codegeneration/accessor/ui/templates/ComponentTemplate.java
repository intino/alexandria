...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "component & child & stamp & multipleDDDDDDDD"))).add(literal("{this.renderInstances(\"")).add(mark("name")).add(literal("\"")).add(expression().add(literal(", { noItemsMessage: \"")).add(mark("noItemsMessage")).add(literal("\" }"))).add(literal(")}")),
