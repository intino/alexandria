...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "component & child & moldable & multiple"))).add(literal("{this.renderInstances(\"")).add(mark("name")).add(literal("\")}")),
			...
			rule().add((condition("type", "extends & moldable"))).add(literal("Displays.")).add(mark("type", "firstUpperCase")),
			...
			rule().add((condition("type", "properties")), (condition("trigger", "common"))).add(expression().add(literal(" label=\"")).add(mark("label")).add(literal("\""))).add(expression().add(literal(" format=\"")).add(mark("format")).add(literal("\""))),
