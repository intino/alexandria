...
public class ComponentTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "component & reference"))).add(literal("<Ui.")).add(mark("type", "firstUpperCase")).add(mark("editable")).add(literal(" id=\"")).add(mark("id")).add(literal("\"")).add(mark("properties", "common")).add(mark("properties", "specific")).add(literal(">")).add(expression().add(literal("\n")).add(literal("\t")).add(mark("component", "child").multiple("\n")).add(literal("\n"))).add(literal("</Ui.")).add(mark("type", "firstUpperCase")).add(mark("editable")).add(literal(">")),
			rule().add((condition("type", "editable"))).add(literal("Editable")),
