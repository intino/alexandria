...
public class SchemaTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("trigger", "schema"))).add(literal("public ")).add(mark("inner")).add(literal(" class ")).add(mark("name", "firstUpperCase")).add(literal(" implements java.io.Serializable {\n\n\t")).add(mark("attribute", "declaration").multiple("\n")).add(literal("\n\n\t")).add(mark("attribute", "getter").multiple("\n\n")).add(literal("\n\n\t")).add(mark("attribute", "setter").multiple("\n\n")).add(literal("\n\t")).add(expression().add(literal("\n")).add(literal("\t")).add(mark("schema").multiple("\n"))).add(literal("\n}")),
