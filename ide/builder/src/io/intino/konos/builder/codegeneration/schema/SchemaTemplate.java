...
public class SchemaTemplate extends Template {
	...
	public Template define() {
		add(
			...
			rule().add((condition("type", "multiple & member")), (condition("trigger", "declaration"))).add(literal("private java.util.List<")).add(mark("type", "firstUpperCase")).add(literal("> ")).add(mark("name", "firstLowerCase")).add(literal("List = new java.util.ArrayList<>();")),
			...
			rule().add((condition("type", "multiple & member")), (condition("trigger", "getter"))).add(literal("public java.util.List<")).add(mark("type", "firstUpperCase")).add(literal("> ")).add(mark("name", "firstLowerCase")).add(literal("List() {\n\treturn this.")).add(mark("name", "firstLowerCase")).add(literal("List;\n}")),
			...
			rule().add((condition("type", "multiple & member")), (condition("trigger", "setter"))).add(literal("public ")).add(mark("element", "firstUpperCase")).add(literal(" ")).add(mark("name", "firstLowerCase")).add(literal("List(java.util.List<")).add(mark("type", "firstUpperCase")).add(literal("> ")).add(mark("name", "firstLowerCase")).add(literal("List) {\n\tthis.")).add(mark("name", "firstLowerCase")).add(literal("List = ")).add(mark("name", "firstLowerCase")).add(literal("List;\n\treturn this;\n}")),
