...
import static io.intino.konos.server.activity.helpers.Bounds.*;
...
public class TimeScaleHandler {
	...
	public ZoomRange zoomRange() {
		Map<TimeScale, Zoom> zooms = bounds.zooms();
	...
	public static class Bounds {
		...
		private Mode mode;
		private Map<TimeScale, io.intino.konos.server.activity.helpers.Bounds.Zoom> zooms;
		...
		public Bounds mode(Mode mode) {
			this.mode = mode;
			return this;
		}

		public Map<TimeScale, io.intino.konos.server.activity.helpers.Bounds.Zoom> zooms() {
			return zooms;
		}

		public Bounds zooms(Map<TimeScale, io.intino.konos.server.activity.helpers.Bounds.Zoom> zooms) {
			this.zooms = zooms;
			return this;
		}
