...
import io.intino.konos.server.activity.displays.molds.model.stamps.icons.SumusIcon;
...
import io.intino.konos.server.activity.displays.schemas.Mold;
import io.intino.konos.server.activity.displays.schemas.MoldBlock;
import io.intino.konos.server.activity.displays.schemas.Property;
import io.intino.konos.server.activity.displays.schemas.Stamp;
...
public class MoldBuilder {
    ...
    public static Mold build(io.intino.konos.server.activity.displays.molds.model.Mold mold) {
    ...
    private static Stamp buildStamp(io.intino.konos.server.activity.displays.molds.model.Stamp stamp) {
    ...
    private static String shapeOf(io.intino.konos.server.activity.displays.molds.model.Stamp stamp) {
    ...
    private static void addCommonProperties(List<Property> propertyList, io.intino.konos.server.activity.displays.molds.model.Stamp stamp) {
    ...
    private static void addRatingProperties(List<Property> propertyList, io.intino.konos.server.activity.displays.molds.model.Stamp stamp) {
        if (! (stamp instanceof Rating)) return;
        propertyList.add(shapeProperty("icon", ((Rating)stamp).ratingIcon()));
    }

    private static void addEmbeddedCatalogProperties(List<Property> propertyList, io.intino.konos.server.activity.displays.molds.model.Stamp stamp) {
        if (! (stamp instanceof EmbeddedCatalog)) return;
        propertyList.add(shapeProperty("catalog", ((EmbeddedCatalog)stamp).catalog().name()));
    }

    private static void addIconProperties(List<Property> propertyList, io.intino.konos.server.activity.displays.molds.model.Stamp stamp) {
        if (! (stamp instanceof Icon)) return;
        propertyList.add(shapeProperty("icon-type", stamp instanceof SumusIcon ? "sumus" : ""));
    }

    private static void addDownloadOperationProperties(List<Property> propertyList, io.intino.konos.server.activity.displays.molds.model.Stamp stamp) {
    ...
    private static void addExportOperationProperties(List<Property> propertyList, io.intino.konos.server.activity.displays.molds.model.Stamp stamp) {
