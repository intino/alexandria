...
import io.intino.konos.server.activity.displays.schemas.Operation;
...
public class ElementViewBuilder {
    ...
    public static ElementView build(io.intino.konos.server.activity.displays.elements.ElementView view) {
    ...
    private static Toolbar buildToolbar(io.intino.konos.server.activity.displays.elements.model.Toolbar toolbar) {
        Toolbar result = new Toolbar();
        toolbar.operations().forEach(op -> result.operationList().add(buildOperation(op)));
        return result;
    }

    private static Operation buildOperation(io.intino.konos.server.activity.displays.elements.model.toolbar.Operation operation) {
    ...
    private static String when(io.intino.konos.server.activity.displays.elements.model.toolbar.Operation operation) {
    ...
    private static List<Property> propertiesOf(io.intino.konos.server.activity.displays.elements.model.toolbar.Operation operation) {
    ...
    private static String type(io.intino.konos.server.activity.displays.elements.model.toolbar.Operation operation) {
    ...
    public static List<ElementView> buildList(List<io.intino.konos.server.activity.displays.elements.ElementView> viewList) {
        return viewList.stream().map(ElementViewBuilder::build).collect(toList());
    }

    private static void addMapViewProperties(ElementView result, io.intino.konos.server.activity.displays.elements.ElementView view) {
