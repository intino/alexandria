...
class SparkWriter {
	...
	public void write(Object object, String name) {
		if (object instanceof teseo.Error) writeError((teseo.Error) object, adapt(object));
	...
	private String adapt(Object object) {
		if (object instanceof teseo.Error) return adaptError((teseo.Error) object);
	...
	private void writeError(teseo.Error response, String message) {
		try {
	...
	private String adaptError(teseo.Error error) {
