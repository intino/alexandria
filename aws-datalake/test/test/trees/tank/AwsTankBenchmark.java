package test.trees.tank;

import io.intino.alexandria.Timetag;
import io.intino.alexandria.datalake.aws.S3;
import io.intino.alexandria.datalake.aws.trees.tank.AwsDatalake;
...
public class AwsTankBenchmark {

    private final AwsDatalake datalake = new AwsDatalake(S3.with(MyClient.s3Client));
